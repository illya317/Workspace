...
SELECT
    ...
    "urgency",
    CASE
        WHEN "category" = 'routine' THEN NULL
        WHEN "isArchived" = true THEN 'archived'
        WHEN "status" = 'done' THEN 'done'
        ELSE 'doing'
    END,
    "ownerEmployeeId",
    CASE WHEN "category" = 'routine' THEN NULL ELSE "startDate" END,
    CASE WHEN "category" = 'routine' THEN NULL ELSE "dueDate" END,
    CASE WHEN "category" = 'routine' THEN NULL ELSE "linkedProjectId" END,
    CASE WHEN "category" = 'routine' THEN NULL ELSE "linkedProjectTaskId" END,
    "parentWorkItemId",
    "isArchived",
    "isPrivate",
    "sortOrder",
