...
const NON_CURRENT_ASSETS: BalanceSheetLineConfig[] = [
  ...
  { lineCode: "fixedAssets",        label: "固定资产",             displayCode: "1601-1602", side: "debit", section: "nonCurrentAssets", prefixes: ["1601"], subtractPrefixes: ["1602"] },
  ...
  { lineCode: "rightOfUse",         label: "使用权资产",           displayCode: "1641-1642", side: "debit", section: "nonCurrentAssets", prefixes: ["1641"], subtractPrefixes: ["1642"] },
