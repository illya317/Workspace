...
export async function validateRequest({ cwd, request, expectedSourceSha, expectedSourceTree, expectedSourceRef, expectedRepository }) {
  if (!request || request.schemaVersion !== 1) fail("CNB deploy request schemaVersion must be 1");
...
export async function createRequest({ cwd, sourceSha, sourceRef, repository, bootstrapContext }) {
