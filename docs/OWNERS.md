...
| Architecture and module boundaries | `docs/engineering/architecture-governance.md`, `docs/engineering/module-boundaries.md`, `docs/engineering/level2-agent-execution.md` | Architecture | Includes route shell, API shell, registry, Platform/Core/App layering, gate semantics. |
