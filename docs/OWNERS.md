...
- Hygiene rejects committed task plans, business ledgers, and stale planning records instead of archiving them in Git.
...
- Reference material unused or unlinked for more than 90 days should be reviewed by Hygiene for deletion, but the declared owner decides whether it is still useful.
