...
| 执行 Architecture 拆出的 Structure 任务包 | Feature / Data / Operations | `docs/engineering/level2-agent-execution.md`、对应模块 `ARCHITECTURE.md` |
...
1. 先读 `docs/engineering/level2-agent-execution.md`，确认动作类型、目标层、依赖顺序和 baseline 权限。
