...
| 文件 | 领域 | 模型 |
|------|------|------|
| `auth-rbac.prisma` | 认证与权限 | User, Resource, UserResourceActionGrant, PositionResourceActionGrant, DepartmentResourceActionGrant |
...
| `work-responsibilities.prisma` | 职责引用 | PositionResponsibilityNode, WorkResponsibilityReference |
...
| `finance-statement.prisma` | 财务报表 | FinanceStatementWorkpaper, FinanceStatementWorkpaperLine |
