...
Domain-specific references remain closer to their owners, for example `docs/product/reference/*` for user/product data sources and `docs/engineering/reference/*` for engineering-owned references.
