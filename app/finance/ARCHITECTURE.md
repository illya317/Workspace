...
新增 service（`server/services/finance/statements/reviews/`）：
...
新增 API：
- `GET /api/finance/statement-reviews?workpaperId=` — `withFinanceReportAccess`
- `GET /api/finance/statement-reviews?companyCode=&year=&month=&reportType=` — `withFinanceReportAccess`
- `POST /api/finance/statement-reviews { workpaperId }` — `withFinanceReportWrite`
- `PUT /api/finance/statement-reviews/[id] { lines[], note? }` — `withFinanceReportWrite`，局部更新
- `POST /api/finance/statement-reviews/[id]/confirm` — `withFinanceReportWrite`
...
| `GET/POST /api/finance/statement-reviews` | 校对查询/生成（P3 Batch 3） |
| `PUT /api/finance/statement-reviews/[id]` | 校对行更新（P3 Batch 3） |
| `POST /api/finance/statement-reviews/[id]/confirm` | 校对确认（P3 Batch 3） |
...
| `/api/finance/statement-reviews` | `withFinanceReportAccess/Write` | 校对查询/生成/更新/确认（P3 Batch 3） |
