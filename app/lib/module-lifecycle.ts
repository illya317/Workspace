...
export const MODULE_LIFECYCLE_BY_RESOURCE: Partial<Record<string, ModuleLifecycleStatus>> = {
  ...
  finance: "workspace-owned",
  "finance.ledger": "workspace-owned",
  "finance.statement": "workspace-owned",
  "finance.analysis": "workspace-owned",
  "finance.budget": "workspace-owned",
  "finance.cost": "workspace-owned",
  "finance.tax": "workspace-owned",
  "finance.treasury": "workspace-owned",
  "finance.import": "workspace-owned",
