...
| `/api/modules/finance/budget` | POST | 导入 Excel 预算，创建 draft 版本 | `finance.budget.import` |
...
| 导入/激活/创建版本 | API: `finance.budget.import` / `finance.budget.approve` / `finance.budget.create` |
