...
新增 API：
- `GET /api/modules/finance/statement-review/reviews?workpaperId=` — `withFinanceReportAccess`
- `GET /api/modules/finance/statement-review/reviews?companyCode=&year=&month=&reportType=` — `withFinanceReportAccess`
- `POST /api/modules/finance/statement-review/reviews { workpaperId }` — `withFinanceReportWrite`
- `PUT /api/modules/finance/statement-review/reviews/[id] { lines[], note? }` — `withFinanceReportWrite`，局部更新
- `POST /api/modules/finance/statement-review/reviews/[id]/confirm` — `withFinanceReportWrite`
...
| `GET/PUT /api/modules/finance/ledger/periods` | 会计期间 |
| `GET /api/modules/finance/statements/reports` | 财务报表 |
| `GET /api/modules/finance/ledger/init` | 财务初始化 |
...
| API | Wrapper | 说明 |
|-----|---------|------|
| `/api/modules/finance/ledger/accounts*` | `withFinanceLedgerAccess/Write/Delete` | 科目管理 |
| `/api/modules/finance/ledger/vouchers*` | `withFinanceLedgerAccess/Write/Delete` | 凭证管理 |
| `/api/modules/finance/ledger/balances*` | `withFinanceLedgerAccess/Write` | 余额查询/重算/校准 |
| `/api/modules/finance/ledger/periods*` | `withFinanceLedgerAccess/Write/Delete` | 会计期间 |
| `/api/modules/finance/ledger/init` | `withFinanceLedgerWrite` | 财务初始化 |
| `/api/modules/finance/statements/reports` | `withFinanceReportAccess` | 报表生成 |
...
| `/api/modules/finance/ledger/reclass-rules` | `withFinanceLedgerAccess/Write` | 重分类规则查询/写入 |
| `/api/modules/finance/ledger/reclass-results` | `withFinanceLedgerAccess/Write` | 重分类结果列表/生成/审核 |
| `/api/modules/finance/statement-review/workpapers` | `withFinanceReportAccess/Write` | 底稿查询/保存（P3 Batch 2） |
| `/api/modules/finance/statement-review/reviews` | `withFinanceReportAccess/Write` | 校对查询/生成/更新/确认（P3 Batch 3） |
