...
export default async function FinanceStatementConfigPage() {
  ...
  const [canCreate, canUpdate, canDelete] = await Promise.all([
    ...
    evaluatePermissionAction(user.id, "finance.statementConfig", "update"),
  ...
  return renderAppShellPage({
    ...
    backHref: "/finance",
    user,
    children: <StatementConfigClient user={user} canCreate={canCreate} canUpdate={canUpdate} canDelete={canDelete} />,
  });
}
