import { buildFinanceAssetSubmissionActionRouteCommand, executeRejectFinanceAssetSubmissionRouteCommand } from "@workspace/finance/server/assets/approvals";
...
export const POST = createCommandRoute({
  ...
  action: executeRejectFinanceAssetSubmissionRouteCommand,
});
