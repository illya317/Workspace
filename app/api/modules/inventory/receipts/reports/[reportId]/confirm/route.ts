...
import { InventoryReceiptReportActionSchema, executeReceiptReportConfirmCommand } from "@workspace/inventory/server/receipts/index";
...
export const POST = createCommandRoute({
  ...
  action: executeReceiptReportConfirmCommand,
});
