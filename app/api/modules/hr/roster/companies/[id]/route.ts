import { deleteCompanyByParams, updateCompanyField, buildHrRouteCommand, idParams, replayJsonRequest } from "@workspace/hr/server";
...
export const PUT = createCommandRoute({
  ...
  action: ({ request, id, body }) => updateCompanyField(replayJsonRequest(request, body), idParams(id)),
});
