import { deleteDepartmentByParams, updateDepartmentField, buildHrRouteCommand, idParams, replayJsonRequest } from "@workspace/hr/server";
...
export const PUT = createCommandRoute({
  ...
  action: ({ request, id, body }) => updateDepartmentField(replayJsonRequest(request, body), idParams(id)),
});
