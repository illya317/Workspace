import { updateEmployeeProfileContracts, buildHrRouteCommand } from "@workspace/hr/server";
...
export const PUT = createCommandRoute({
  ...
  action: ({ employeeId, rows, userId }) => updateEmployeeProfileContracts(employeeId, rows, userId),
});
