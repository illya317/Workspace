...
test("libraryOfficeSourcePath targets the Library-owned canonical endpoint", () => {
  assert.equal(
    libraryOfficeSourcePath(84, 91),
    "/api/modules/library/integrations/onlyoffice/documents/84/versions/91",
  );
});
