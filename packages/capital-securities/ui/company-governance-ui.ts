    ...
    items: [
      ...
      text("registeredCapital", "注册资本"),
      {
        ...
        spec: {
          ...
          options: {
            source: "remote",
            fkKey: "finance.currency.catalog",
            endpoint: "/api/modules/capitalSecurities/governance/currency-options",
            returnField: "id",
          },
        },
        value: draft.currencyId > 0 ? String(draft.currencyId) : "",
        onChange: (value) => onChange("currencyId", value ? Number(value) : 0),
      },
      {
        key: "isConsolidationParent",
        label: "合并母公司",
        hint: "集团列报币种自动采用该公司的本位币；同一集团仅保留一个合并母公司",
        spec: {
          valueType: "boolean",
          control: "boolean",
        ...
        value: draft.isConsolidationParent,
        onChange: (value) => onChange("isConsolidationParent", Boolean(value)),
      },
      {
        key: "registeredDate",
        label: "注册日期",
