...
export const CAPITAL_SECURITIES_COMPANIES_ANALYSIS_SOURCE = defineWorkspaceAnalysisReadModel<CompanyRecord>()({
  ...
  fields: {
    ...
    currencyId: field({ label: "本位币 ID", description: "公司本位币引用的统一币种目录标识。", valueKind: "integer", sensitivity: "internal" }),
    functionalCurrency: field({ label: "本位币代码", description: "公司本位币 ISO 代码。", valueKind: "text", sensitivity: "internal" }),
    functionalCurrencyName: field({ label: "本位币名称", description: "公司本位币名称。", valueKind: "text", sensitivity: "internal" }),
    isConsolidationParent: field({ label: "合并母公司", description: "是否为当前集团合并口径母公司。", valueKind: "boolean", sensitivity: "internal" }),
