...
export const HR_PERFORMANCE_ATTENDANCE_ANALYSIS_SOURCE = defineWorkspaceAnalysisReadModel<HrPerformanceAttendanceAnalysisRow>()({
...
export const HR_PERFORMANCE_WORK_PLANS_ANALYSIS_SOURCE = defineWorkspaceAnalysisReadModel<HrPerformanceWorkPlanAnalysisRow>()({
...
export const HR_PERFORMANCE_CONTRIBUTIONS_ANALYSIS_SOURCE = defineWorkspaceAnalysisReadModel<HrPerformanceContributionAnalysisRow>()({
...
export const HR_PERFORMANCE_REVIEWS_ANALYSIS_SOURCE = defineWorkspaceAnalysisReadModel<HrPerformanceReviewAnalysisRow>()({
...
export const HR_PERFORMANCE_REVIEW_DETAILS_ANALYSIS_SOURCE = defineWorkspaceAnalysisReadModel<HrPerformanceReviewDetailAnalysisRow>()({
...
export const HR_PERFORMANCE_REVIEW_EVIDENCE_VALUES_ANALYSIS_SOURCE = defineWorkspaceAnalysisReadModel<HrPerformanceReviewEvidenceValueAnalysisRow>()({
...
export const HR_PERFORMANCE_CYCLES_ANALYSIS_SOURCE = defineWorkspaceAnalysisReadModel<HrPerformanceCycleAnalysisRow>()({
...
export const HR_PERFORMANCE_REPORTING_ANALYSIS_SOURCE = defineWorkspaceAnalysisReadModel<HrPerformanceReportingAnalysisRow>()({
...
export const HR_WORKSPACE_ANALYSIS_PERFORMANCE_SOURCE_REGISTRATIONS = [
  HR_PERFORMANCE_ATTENDANCE_ANALYSIS_SOURCE,
  HR_PERFORMANCE_WORK_PLANS_ANALYSIS_SOURCE,
  HR_PERFORMANCE_CONTRIBUTIONS_ANALYSIS_SOURCE,
  HR_PERFORMANCE_REVIEWS_ANALYSIS_SOURCE,
  HR_PERFORMANCE_REVIEW_DETAILS_ANALYSIS_SOURCE,
  HR_PERFORMANCE_REVIEW_EVIDENCE_VALUES_ANALYSIS_SOURCE,
  HR_PERFORMANCE_CYCLES_ANALYSIS_SOURCE,
  HR_PERFORMANCE_REPORTING_ANALYSIS_SOURCE,
] as const;

const performanceSourceKeys = new Set(HR_WORKSPACE_ANALYSIS_PERFORMANCE_SOURCE_REGISTRATIONS.map((registration) => (
  registration.definition.sourceKey
)));

export function isHrPerformanceWorkspaceAnalysisSourceKey(sourceKey: string) {
  return performanceSourceKeys.has(sourceKey);
}
