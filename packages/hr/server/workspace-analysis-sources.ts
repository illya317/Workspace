...
export const HR_CONTRACTS_ANALYSIS_SOURCE = defineWorkspaceAnalysisReadModel<ContractRow>()({
  ...
  fields: {
    id: field({ label: "合同合成 ID", description: "由雇佣记录与合同序号组成的稳定页内标识。", valueKind: "integer", sensitivity: "internal" }),
    ...
    firstContractEndDate: field({ label: "首签结束", description: "首份合同结束日期。", valueKind: "date", sensitivity: "confidential" }),
    secondContractStartDate: field({ label: "续签一开始", description: "第一次续签开始日期。", valueKind: "date", sensitivity: "confidential" }),
    secondContractEndDate: field({ label: "续签一结束", description: "第一次续签结束日期。", valueKind: "date", sensitivity: "confidential" }),
    thirdContractStartDate: field({ label: "续签二开始", description: "第二次续签开始日期。", valueKind: "date", sensitivity: "confidential" }),
    thirdContractEndDate: field({ label: "续签二结束", description: "第二次续签结束日期。", valueKind: "date", sensitivity: "confidential" }),
    ...
    endDate: field({ label: "合同终止日期", description: "合同实际终止日期。", valueKind: "date", sensitivity: "confidential" }),
  },
  pagination: defaultPagination,
  limits: defaultLimits,
});
