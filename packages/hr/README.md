...
- `ui/components/{AutoSizeInput,EntitySearchInput,EthnicityPicker,FKInput,MajorPicker,OptionPicker,ProfessionalTitlePicker,RankPicker,SchoolPicker}.tsx`：HR 专用字段、FK 和选项选择器。
