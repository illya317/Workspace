  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
        <MetricCard label="当前在职" value={stats.currentActive} />
        <MetricCard label="本月入职" value={stats.thisMonthJoins} />
        <MetricCard label="本月离职" value={stats.thisMonthLeaves} />
        <MetricCard label="本月净变动" value={stats.thisMonthNet > 0 ? `+${stats.thisMonthNet}` : stats.thisMonthNet} />
        <MetricCard label="年度入职" value={stats.yearJoins} />
        <MetricCard label="年度离职" value={stats.yearLeaves} />
      </div>
