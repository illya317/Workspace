...
const LEVEL_LABEL: Record<number, string> = { 1: "M1 管理一级", 2: "M2 部门", 3: "M3 子部门" };
  ...
  return createAnalysisSection("dept-bars", {
        ...
        sections: [
          createInlineFieldsSection("dept-bars-filters", [{
            key: "l1",
            label: "M1组织",
            spec: { valueType: "string", control: "choice", options: { source: "static", items: l1List.map((dept) => ({ value: String(dept.id), label: dept.name })) } },
