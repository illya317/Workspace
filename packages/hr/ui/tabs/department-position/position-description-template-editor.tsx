...
import { createActionsSection, createPageBody, BodySurface, createSectionsSection, createPanelSection, type BodySurfaceSectionSpec } from "@workspace/core/ui";
...
export function PositionDescriptionTemplateEditor({
  ...
  return <BodySurface {...createPageBody([createPositionDescriptionTemplateEditorSection({ name, fields, onNameChange, onToggleField, onSave, onCancel })])} />;
}
