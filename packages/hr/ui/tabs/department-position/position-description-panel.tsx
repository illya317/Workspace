...
import { createPageBody, createPanelSection, BodySurface, type FormSurfaceItemSpec, type FormSurfaceLooseItem, type BodySurfaceSectionSpec } from "@workspace/core/ui";
...
import { usePositionDescriptionDetailsSurface } from "./detail-editors";
...
export function usePositionDescriptionPanelSection({
  ...
  const descriptionFields: FormSurfaceItemSpec<FormSurfaceLooseItem>[] = [
    ...
    { kind: "readonly", key: "department", label: "说明书组织", value: position.departmentName || "未设置" },
    {
      key: "headcount",
      label: "编制",
...
export function PositionDescriptionPanel(props: Omit<PositionDescriptionPanelProps, "position" | "descriptionDraft"> & {
  ...
  return <BodySurface {...createPageBody(section ? [section] : [])} />;
}
