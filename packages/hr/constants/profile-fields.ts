...
export const employmentFields: ProfileField[] = [
  ...
  { key: "leaveReason", label: "离职原因", type: "select", options: HR_LEAVE_REASONS },
...
export const edpFields: ProfileField[] = [
  ...
  { key: "reportTo", label: "直接上级", type: "fk", entity: "employee", fkKey: "hr.edp.reportTo", valueFrom: "name", activeOnly: true, required: true },
];
