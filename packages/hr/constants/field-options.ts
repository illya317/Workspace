...
export const HR_VIRTUAL_EMPLOYEE_PERSONNEL_TYPE = "虚拟员工";
export const HR_PERSONNEL_TYPES = ["关键管理人员", "关键技术人员", "核心人员", HR_VIRTUAL_EMPLOYEE_PERSONNEL_TYPE, "其他"];
export const HR_EDITABLE_PERSONNEL_TYPES = HR_PERSONNEL_TYPES.filter(
  (value) => value !== HR_VIRTUAL_EMPLOYEE_PERSONNEL_TYPE,
);
