...
const employmentFields: FieldConfig[] = [
  ...
  { key: "isActive", label: "在职", editable: false, type: "boolean", booleanLabels: { true: "在职", false: "离职" }, defaultVisible: true },
  ...
  { key: "joinDate", label: "入职日期", editable: false, type: "date", defaultVisible: true },
  { key: "leaveDate", label: "离职日期", editable: false, type: "date", hidden: true },
...
const edpFields: FieldConfig[] = [
  ...
  { key: "isPrimary", label: "主岗", editable: false, type: "boolean", defaultVisible: true },
...
const contractFields: FieldConfig[] = [
  ...
  { key: "company", label: "公司", editable: false, filterEntity: "company", defaultVisible: true },
  { key: "legalRelation", label: "法律关系", editable: false, type: "select", defaultVisible: true },
  { key: "contractType", label: "协议类型", editable: false, type: "select", defaultVisible: true },
  { key: "employmentForm", label: "用工形式", editable: false, type: "select", defaultVisible: true },
  { key: "firstContractStartDate", label: "首签开始", editable: false, type: "date", defaultVisible: true },
  { key: "firstContractEndDate", label: "首签到期", editable: false, type: "date", defaultVisible: true },
  { key: "secondContractStartDate", label: "续签一开始", editable: false, type: "date" },
  { key: "secondContractEndDate", label: "续签一到期", editable: false, type: "date" },
  { key: "thirdContractStartDate", label: "续签二开始", editable: false, type: "date" },
  { key: "thirdContractEndDate", label: "续签二到期", editable: false, type: "date" },
  { key: "permanentContractDate", label: "无固定期限", editable: false, type: "date" },
  { key: "expiryDate", label: "到期日期", editable: false, type: "date", defaultVisible: true },
  { key: "endDate", label: "结束日期", editable: false, type: "date", defaultVisible: true },
];

export const contractConfig: TabConfig = {
  title: "协议",
  apiPath: "/api/modules/hr/roster/contracts",
  entityType: "EmploymentAgreement",
