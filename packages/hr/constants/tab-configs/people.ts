...
const contractFields: FieldConfig[] = [
  ...
  { key: "isPrimary", label: "主合同", type: "boolean", editable: false, defaultVisible: true },
  { key: "insuranceStatus", label: "参保状态", type: "select", editable: false, defaultVisible: true },
  { key: "legalRelation", label: "法律关系", editable: false, type: "select", defaultVisible: true },
  { key: "contractType", label: "合同类型", editable: false, type: "select", defaultVisible: true },
  ...
  { key: "firstContractEndDate", label: "首签结束", editable: false, type: "date", defaultVisible: true },
