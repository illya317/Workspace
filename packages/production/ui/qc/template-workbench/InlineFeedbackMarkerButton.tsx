...
export default function InlineFeedbackMarkerButton({
  ...
  return (
    <button
      type="button"
      className={[
        "inline-flex h-6 w-6 items-center justify-center rounded-full border p-0 shadow-md backdrop-blur-sm transition focus:outline-none focus:ring-2 focus:ring-sky-200",
        saved
    ...
    >
      <svg aria-hidden="true" className="h-3.5 w-3.5 shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor">
