...
import { PageSurface, createPageBody, type BodySurfaceSectionSpec } from "@workspace/core/ui";
...
export function createQcBatchTableSection({
  rows,
  onView,
  onDelete,
}: {
...
export function QcBatchTable({
  ...
  return (
    <PageSurface kind="standard"
      embedded
      body={createPageBody([createQcBatchTableSection({ rows, onView, onDelete })], { layout: "stack" })}
