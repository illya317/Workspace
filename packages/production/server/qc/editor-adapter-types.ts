...
export interface QcEditorImportAudit {
  schemaVersion: 1;
  source: "qc-template-import";
  counts: {
    source: QcEditorCountSummary;
    editor: QcEditorCountSummary;
  };
  countDeltas: {
    editorMinusSource: Pick<QcEditorCountSummary, "tables" | "fields" | "formulas">;
  };
  keyCountChecks: {
...
export interface QcEditorImportResult {
  document: EditorDocument;
  fieldModel: EditorFieldModel;
  audit: QcEditorImportAudit;
}
