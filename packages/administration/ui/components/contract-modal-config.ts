...
export interface ContractFormFieldConfig {
  ...
  required?: boolean;
  type?: "number";
  choice?: "category" | "status" | "location";
  reference?: "employee";
}

export const CONTRACT_STATUS_OPTIONS = ["未盖章", "执行中", "已终止", "已结束"] as const;
...
export const CONTRACT_FORM_FIELD_CONFIGS: ContractFormFieldConfig[] = [
  ...
  { label: "合同类型", key: "category", required: true, choice: "category" },
  { label: "状态", key: "status", choice: "status" },
  { label: "签署方", key: "partyA" },
  { label: "签署对方", key: "partyB" },
  { label: "股东方", key: "shareholder" },
  { label: "经办人", key: "handlerEmployeeId", reference: "employee" },
  { label: "合同金额", key: "amount", type: "number" },
  { label: "已执行金额", key: "executedAmount", type: "number" },
  { label: "文件位置", key: "location", choice: "location" },
];
