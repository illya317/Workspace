import {
  DEFAULT_WORK_REPORTING_SETTINGS,
...
export type { WorkReportingPeriodSettings, WorkReportingSettings } from "@workspace/platform/work-reporting-policy";
...
export const WORK_OKR_CONTROL_SETTINGS_KEY = WORK_REPORTING_SETTINGS_CONFIG_KEY;
...
const DEFAULT_WORK_OKR_CONTROL_SETTINGS: WorkOkrControlSettings = {
  ...
  reporting: DEFAULT_WORK_REPORTING_SETTINGS,
};
...
export function normalizeWorkOkrControlSettings(value: unknown): WorkOkrControlSettings {
  ...
  return {
    ...
    reporting: normalizeWorkReportingSettings(source.reporting),
  };
}
