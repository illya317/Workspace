...
export async function resolveWorkTaskActionRuntimes(
  ...
  const [itemCreate, itemUpdate, planCreate, planSave, objectiveSubmit, planRevision, collaboration] = await Promise.all([
  ...
  return { itemCreate, itemUpdate, planCreate, planSave, objectiveSubmit, planRevision, collaboration };
}
