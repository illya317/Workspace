...
import { canEditWorkTask } from "./access";
import { createWorkPlan, getWorkPlanTargetMetadata, updateWorkPlan } from "./work-plans";
import {
...
async function linkCandidateToWorkPlan(
  ...
  const metadata = await getWorkPlanTargetMetadata(workPlanId);
