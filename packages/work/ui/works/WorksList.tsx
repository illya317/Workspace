...
import { createPageBody, createStatusSection, PageSurface } from "@workspace/core/ui";
...
function EmptyWorksSurface({ blockKey, empty }: { blockKey: string; empty: string }) {
  return <PageSurface kind="standard" embedded body={createPageBody([createStatusSection(blockKey, { kind: "empty", content: empty })])} />;
}
