...
import type { RoutineRecurrenceType, RoutineTaskType, WorkItem, WorkItemDraft, WorkItemStatus, WorkItemType, WorkOkrStage, WorkPeriodType, WorkPlan, WorkPlanDraft, WorkPlanKind, WorkSourceKind, WorkSourceType, WorkTargetType } from "./types";
...
export const OKR_CONTROL_SCOPE_OPTIONS = [{ value: "global", label: "全局" }, { value: "company", label: "公司" }, { value: "committee", label: "委员会" }, { value: "department", label: "部门" }];
