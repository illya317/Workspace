...
export interface WorkReportDraftResponse {
  ...
  reportingPolicy: import("./work-okr-settings-types").WorkReportingPolicy | null;
  reportingSettings: import("./work-okr-settings-types").WorkReportingSettings;
  cycleOptions: import("./work-okr-settings-types").WorkOkrControlCycleOption[];
  reportStage?: "kr" | "final";
  canEdit: boolean;
