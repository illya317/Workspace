  ...
  return (
    <section className={joinClassNames("relative z-10 border-y border-slate-100 bg-white px-0 py-2", className)}>
      ...
      >
        ...
        <div className="flex min-w-0 max-w-full flex-1 flex-wrap items-center gap-x-3 gap-y-2 [&_[data-field-control]]:!h-9 [&_[data-field-control]]:min-w-28 [&_[data-field-control]>*]:w-full [&_[data-field-label]]:!h-9 [&_[data-field-label]]:text-xs">
          {inlineChildren}
        </div>
