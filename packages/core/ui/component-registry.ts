...
export const coreUiComponentRegistry = [
  ...
  { name: "FkFieldInput", kind: "picker", description: "外键实体搜索输入，只负责展示和选择，业务 FK 契约来自 Platform。", example: "搜索“张”后从员工候选项中选择一个负责人。", includes: ["SearchInput"] },
  { name: "FieldValueFilter", kind: "toolbar", description: "字段和值组合筛选，工具栏只显示“字段：值”，点击后再选择字段和值；字段可声明 FK，由 Core 走 Platform FK 搜索。", example: "显示“员工：张文孝”，点击后先选字段，再用 FK 搜索选择员工。", includes: ["SelectField", "SearchInput", "FkFieldInput"] },
