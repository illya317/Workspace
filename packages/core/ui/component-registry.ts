...
export const coreUiComponentRegistry = [
  ...
  { name: "ActionGlyph", kind: "toolbar", description: "通用动作图标 glyph，统一新增、编辑、查看、确认、取消和删除的图形表达。", example: "Block 新增确认和 DataTable 行编辑都复用同一套勾叉图标。" },
  ...
  { name: "BlockCreatePanel", kind: "form", description: "块状新建模式，用于需要多行或多字段的新建表单；标题旁只承载 +、取消和确认动作，编辑入口应放到行级 DataTable actions。", example: "项目阶段和项目任务这类多字段新增，不常驻表单，点击标题旁 + 后展开维护。", includes: ["CreateStartButton", "CreateConfirmActions"] },
  ...
  { name: "CreateConfirmActions", kind: "form", description: "新建模式的确认/取消图标动作 primitive，供 InlineCreatePanel、BlockCreatePanel 和工具条新建态共享。", example: "新建态标题旁展示取消和确认按钮，不在业务页手写 x/勾图标。", includes: ["ActionButton", "ActionGlyph"] },
  { name: "CreateStartButton", kind: "form", description: "新建模式的 + 入口 primitive，统一普通态、激活态和禁用态。", example: "列表、阶段或任务区进入新建态时，标题旁 + 高亮。", includes: ["IconActionButton", "ActionGlyph"] },
  ...
  { name: "isDataTableEditDirty", kind: "data", description: "DataTable 行编辑 dirty 判断工具，和 createDataTableEditActions 配套使用。", example: "项目任务和工作项行编辑时统一判断保存按钮是否需要高亮。" },
  ...
  { name: "DisclosureSectionHeader", kind: "navigation", description: "可折叠分组标题 primitive，统一展开箭头、数量徽标和点击区域。", example: "工作计划中切换“日常工作 / 其他工作 / 已归档”分组。" },
  ...
  { name: "RatingControl", kind: "form", description: "星级评分 primitive，统一只读和可编辑评分按钮样式。", example: "工作计划中展示或编辑重要度、紧急度评分。" },
  ...
  { name: "ToolbarSelectFilter", kind: "toolbar", description: "工具栏专用下拉筛选，统一“标签 + 当前值 + 下拉菜单”的紧凑列表筛选样式。", example: "合同台账里用“类型 全部”“状态 执行中”筛选记录，避免业务页手写下拉筛选按钮。", includes: ["SearchInput"] },
