...
export const coreUiComponentRegistry = [
  ...
  { name: "AnalysisPageFrame", tier: "frame", kind: "layout", description: "分析页骨架，统一页内 Tab、指标条和分析内容块间距。", example: "人力分析或财务分析页面只传 tabs、metrics 和 AnalysisBlock 内容。", composes: ["PageContent", "AccordionTabBar"] },
  ...
  { name: "DatabasePageFrame", tier: "frame", kind: "layout", description: "数据库页骨架，统一 Tab、筛选工具条、摘要和表格内容排列。", example: "员工资料、财务科目、报表配置和注册表页面只传筛选区与 DataTable。", composes: ["PageContent", "AccordionTabBar"] },
  ...
  { name: "HierarchyBadge", tier: "primitive", kind: "status", description: "层级徽标（deprecated / Badge 兼容薄壳）。新代码请直接使用 Badge。", example: "在部门树节点上显示一级、二级或三级层级标识。", composes: ["Badge"] },
  ...
  { name: "StatusBadge", tier: "primitive", kind: "status", description: "状态徽标（deprecated / Badge 兼容薄壳）。新代码请直接使用 Badge。", example: "显示“已启用”“已归档”“待审核”等状态。", composes: ["Badge"] },
