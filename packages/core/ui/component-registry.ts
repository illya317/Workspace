...
export const coreUiComponentRegistry = [
  ...
  { name: "ActionGlyph", tier: "primitive", kind: "toolbar", description: "通用动作图标 glyph，统一新增、编辑、查看、确认、取消和删除（含删除叉与删除桶两种变体）的图形表达。", example: "Block 新建确认和 DataTable 行编辑用取消/删除叉；需要明显删除语义时用删除桶。" },
