...
export const coreUiComponentRegistry = [
  ...
  { name: "ActionGlyph", tier: "primitive", kind: "toolbar", description: "通用动作图标 glyph，统一新增、编辑、查看、确认、取消和删除（含删除叉、删除桶、删除减号三种变体）的图形表达。", example: "Block 新建确认和 DataTable 行编辑用取消/删除叉；需要明显删除语义时用删除桶；轻量移除可用删除减号。" },
  ...
  { name: "BlockCreatePanel", tier: "assembly", kind: "form", description: "块状新建模式，用于需要多行或多字段的新建表单；标题旁只承载 +、取消和确认动作，编辑入口应放到行级 DataTable actions。", example: "项目阶段和项目任务这类多字段新增，不常驻表单，点击标题旁 + 后展开维护。", composes: ["CreateStartButton", "CreateConfirmActions"] },
  ...
  { name: "DataTableActionsCell", tier: "primitive", kind: "data", description: "表格操作列模板，统一查看、编辑、删除等行级动作图标。", example: "员工资料和批次记录表格都用查看/删除图标，不再手写操作列按钮。", composes: ["DataTableActionButton"] },
  ...
  { name: "FieldValueFilter", tier: "assembly", kind: "toolbar", description: "字段和值组合筛选，工具栏只显示“字段：值”，点击后再选择字段和值；字段可声明 FK，并由业务域传入 reference-options endpoint。", example: "显示“员工：张文孝”，点击后先选字段，再用 HR reference-options 搜索选择员工。", composes: ["SelectField", "SearchInput", "FkFieldInput"] },
  { name: "FilterBar", tier: "assembly", kind: "toolbar", description: "筛选栏容器，用于承载多个筛选字段和操作区。", example: "在数据库页承载关键词、状态、部门和分页大小控件。" },
  { name: "FilterToolbar", tier: "assembly", kind: "toolbar", description: "列表筛选工具栏，统一搜索、下拉筛选和操作按钮。", example: "在项目列表顶部统一展示搜索、状态下拉和每页条数。", composes: ["SearchInput", "SelectField"] },
  ...
  { name: "ModuleCardBody", tier: "assembly", kind: "layout", description: "模块入口卡片主体，封装图标、标题、描述、徽标和动作。", example: "设置首页或模块首页展示可进入的功能卡片。", foundations: ["moduleCardColorClasses", "getModuleCardClassName"] },
  ...
  { name: "PageStyleShowcase", tier: "frame", kind: "layout", description: "页面样式预览中心，按八大业务板块展示页眉、Tab、Toolbar、主体、页脚、预览和弹出框模板。", example: "架构任务用它审阅财务、生产、人事、工作、行政、外部关系、文档中心和资料库页面样式。", composes: ["AccordionTabBar", "CommandToolbar", "DataTable", "Pagination", "SplitWorkspace", "AnalysisBlock", "StructuredTable"] },
  ...
  { name: "PickerShell", tier: "assembly", kind: "picker", description: "选择器外壳，统一搜索、列表、空态和候选项区域。", example: "组合搜索框、候选列表和无匹配提示的选择器外壳。", composes: ["SearchInput"] },
  ...
  { name: "RemovableTag", tier: "assembly", kind: "form", description: "可删除标签模板，统一 chip 外观、内置 x 删除入口和确认弹窗；业务不要手写 tag 内删除按钮。", example: "项目成员、岗位别名、人事标签列表都用 RemovableTag，点击 x 删除，点击标签文本不触发删除。", composes: ["TagRemoveButton"] },
  ...
  { name: "TemplateWorkbenchFrame", tier: "frame", kind: "layout", description: "模板结构工作台骨架，统一左侧模板选择、顶部搜索筛选、右侧阶段/项目行和行级动作承载区。", example: "生产检验模板页把产品、阶段、检测项和业务反馈/预览动作映射进来，特化弹窗留在业务包设计。", composes: ["CommandToolbar", "SearchInput", "SelectorCard", "PanelCard", "StatusBadge", "ActionButton"] },
  ...
  { name: "WorkspaceSplitPage", tier: "frame", kind: "layout", description: "主从分栏页面骨架，统一 3/7 分栏、移动端抽屉和显示隐藏工具条。", example: "项目、部门岗位和资料库详情页左侧选择对象，右侧编辑详情。", composes: ["SplitWorkspace", "SplitWorkspaceToolbar"] },
  ...
  { name: "getModuleCardClassName", tier: "foundation", kind: "layout", description: "模块卡片样式 recipe，按颜色分类返回图标背景、悬停和 ring class。", example: "设置首页功能卡片按人力资源、财务等分类使用统一颜色变体。" },
