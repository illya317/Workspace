...
export const coreUiComponentRegistry = [
  ...
  { name: "ArchiveSelectorPanel", tier: "assembly", kind: "picker", description: "实体选择面板的旧归档语义入口，后续应收敛成中性选择器。", example: "选择现用、全部或已归档实体时，业务只传入文案和数据。", composes: ["EmptyStateCard", "PanelCard", "SearchInput"] },
  ...
  { name: "CalendarDateInput", tier: "primitive", kind: "form", description: "日期输入 primitive，替代原生 date input 并统一日期交互。", example: "在人事入职日期或合同截止日期字段中选择 2026-06-20。", foundations: ["getFieldInputClassName"] },
  ...
  { name: "PageStyleShowcase", tier: "frame", kind: "layout", description: "页面样式预览中心，按八大业务板块展示页眉、Tab、Toolbar、主体、页脚、预览和弹出框模板。", example: "架构任务用它审阅财务、生产、人事、工作、行政、外部关系、文档中心和资料库页面样式。", composes: ["AccordionTabBar", "CommandToolbar", "DataTable", "Pagination", "SplitWorkspace", "AnalysisBlock", "StructuredTable", "DatabasePageFrame", "PanelCard"] },
  ...
  { name: "TemplateWorkbenchFrame", tier: "frame", kind: "layout", description: "模板结构工作台骨架，统一左侧模板选择、顶部搜索筛选、右侧阶段/项目行和行级动作承载区。", example: "生产检验模板页把产品、阶段、检测项和业务反馈/预览动作映射进来，特化弹窗留在业务包设计。", composes: ["CommandToolbar", "SearchInput", "SelectorCard", "PanelCard", "StatusBadge", "ActionButton", "EmptyStateCard"] },
  { name: "TextareaField", tier: "primitive", kind: "form", description: "多行文本输入 primitive，替代业务包手写 textarea。", example: "在人事备注、合同说明或资料描述中输入多行文本。" },
  { name: "TextField", tier: "primitive", kind: "form", description: "通用文本输入 primitive，替代业务包直接手写原生 input。", example: "设置弹窗中输入用户名、密码或短文本字段。", foundations: ["getFieldInputClassName"] },
