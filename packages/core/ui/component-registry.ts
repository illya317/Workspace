...
export const coreUiComponentRegistry = [
  ...
  { name: "ActionToolbar", tier: "assembly", kind: "toolbar", description: "通用页面动作栏，承接主按钮、次按钮和左右插槽。", example: "在资料库列表顶部显示“已选择 2 条记录 / 导出 / 新增”。", composes: ["ActionButton", "IconActionButton"] },
