...
const coreUiComponentRegistryRaw = [
  ...
  { name: "PageToolbar", tier: "shell", kind: "toolbar", description: "页面级工具栏", example: "列表页顶部只传 features 数组和业务回调，即可组合出视图切换、搜索、状态筛选、新建、导出、编辑和分页信息。", composes: ["Toolbar", "ActionButton", "SelectField", "ToolbarOptionGroup"] },
  ...
  { name: "OptionPicker", tier: "shell", kind: "picker", description: "选项选择器", example: "从少量本地枚举中选择部门、状态或类别。", composes: ["PickerShell", "SearchInput", "PickerOptionButton"] },
  { name: "Picker", tier: "shell", kind: "picker", description: "统一选择器", example: "从分类再选具体值（如专业、职称），或从平铺枚举中直接选择。", composes: ["PickerShell", "PickerOptionButton"] },
  ...
  { name: "PageStyleShowcase", tier: "frame", kind: "layout", description: "页面样式预览", example: "架构任务用它审阅财务、生产、人事、工作、行政、外部关系、文档中心和资料库页面样式。", composes: ["TabBar", "Toolbar", "DataTable", "Pagination", "SplitWorkspace", "AnalysisBlock", "StructuredTable", "DatabasePageFrame", "PanelCard"] },
  ...
  { name: "SplitWorkspaceToolbar", tier: "assembly", kind: "toolbar", description: "分栏工具条", example: "在左右分栏顶部提供收起列表和保存详情按钮。", composes: ["Toolbar", "ActionButton"] },
  ...
  { name: "WorkspaceSplitPage", tier: "frame", kind: "layout", description: "主从分栏页面", example: "项目、部门岗位和资料库详情页左侧选择对象，右侧编辑详情。", composes: ["PageContent", "SplitWorkspace", "SplitWorkspaceToolbar"] },
