...
export const coreUiComponentRegistry = [
  ...
  { name: "CommandToolbar", kind: "toolbar", description: "综合命令栏容器，按隐藏/显示、新建、搜索、互斥筛选、字段筛选、刷新、页面动作、编辑动作和分页信息分区；一行优先，空间不足自动换行。", example: "列表页同时承载左右分栏控制、新建入口、搜索筛选、导出、编辑保存和分页信息。", includes: ["SearchInput", "ToolbarOptionGroup", "FieldValueFilter", "IconActionButton", "ActionButton", "SelectField"] },
  ...
  { name: "FieldValueFilter", kind: "toolbar", description: "字段和值组合筛选，工具栏只显示“字段：值”，点击后再选择字段和值。", example: "显示“状态：缺失”，点击后先选字段再选值。", includes: ["SelectField", "SearchInput"] },
  ...
  { name: "PageStyleShowcase", kind: "layout", description: "页面样式预览中心，按八大业务板块展示页眉、Tab、Toolbar、主体、页脚、预览和弹出框模板。", example: "设置的数据治理页用它审阅财务、生产、人事、工作、行政、外部关系、文档中心和资料库页面样式。", includes: ["AccordionTabBar", "CommandToolbar", "DataTable", "Pagination", "SplitWorkspace", "AnalysisBlock", "StructuredTable"] },
  ...
  { name: "TagRemoveButton", kind: "form", description: "标签删除按钮 primitive，统一 chip 内删除动作尺寸、hover 和禁用态。", example: "员工别名、岗位别名或标签输入中删除某个 chip。" },
  ...
  { name: "WorkspaceSplitPage", kind: "layout", description: "主从分栏页面骨架，统一 3/7 分栏、移动端抽屉和显示隐藏工具条。", example: "工作计划、部门岗位和资料库详情页左侧选择对象，右侧编辑详情。", includes: ["SplitWorkspace", "SplitWorkspaceToolbar"] },
