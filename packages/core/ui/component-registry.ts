...
export const coreUiComponentRegistry = [
  ...
  { name: "BlockCreatePanel", kind: "form", description: "块状新建模式，用于需要多行或多字段的新建表单；标题旁显示 +、取消和确认动作，表单主体按块展开。", example: "计划阶段和项目任务这类多字段新增，不常驻表单，点击标题旁 + 后展开维护。" },
  ...
  { name: "CreateConfirmActions", kind: "form", description: "新建模式的确认/取消图标动作 primitive，供 InlineCreatePanel 和 BlockCreatePanel 共享。", example: "新建态标题旁展示取消和确认按钮，不在业务页手写 x/勾图标。", includes: ["ActionButton"] },
  { name: "CreateStartButton", kind: "form", description: "新建模式的 + 入口 primitive，统一普通态、激活态和禁用态。", example: "列表、阶段或任务区进入新建态时，标题旁 + 高亮。" },
