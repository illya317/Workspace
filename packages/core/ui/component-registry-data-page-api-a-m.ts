...
export const page_api_registry_entries = [
  ...
  },
  {
    ...
    composes: ["FieldGrid", "FormField", "InputControl", "ReadOnlyField", "TagListInput", "SegmentedCodeInput", "TextField", "TextareaField", "CalendarDateInput", "ChoiceGroup", "SelectField", "FileField", "HiddenDataField", "DetailModal", "CommandButton"],
  },
  {
    name: "FormShell",
    accessLayer: "page-api",
