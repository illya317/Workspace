...
export const page_api_registry_entries = [
  ...
  },
  {
    ...
    uiLevel: 1,
    kind: "data",
    description: "L1 数据展示 Surface",
    example: "业务页通过 kind='table'/'structured'/'records'/'metrics'/'raw' 声明数据展示，不直接拼 DataTable、记录卡或 raw code block。",
    composes: ["DataTable", "TableScrollFrame", "StructuredTable", "DisclosureRecordCard", "MetricCard", "CodeBlock", "Badge", "NumberCell", "AmountCell", "InputControl", "SelectionGrid", "Pagination", "Toolbar", "CommandButton", "EmptyStateCard", "PanelCard"],
  },
  {
    name: "AnalysisBlock",
    accessLayer: "page-api",
  ...
  },
  {
    ...
    uiLevel: 1,
    kind: "form",
    description: "L1 表单 Surface",
    example: "业务页通过 kind='fields'/'filters'/'modal'/'inline'/'detail' 和 fields spec 渲染表单、筛选或详情字段。",
    composes: ["FieldGrid", "FormField", "InputControl", "ReadOnlyField", "TagListInput", "TextField", "TextareaField", "CalendarDateInput", "ChoiceGroup", "SelectField", "FileField", "HiddenDataField", "DetailModal", "Toolbar", "CommandButton"],
  },
  {
    name: "FormShell",
    accessLayer: "page-api",
