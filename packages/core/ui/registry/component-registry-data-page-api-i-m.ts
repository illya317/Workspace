...
export const page_api_registry_entries = [
    ...
    declares: [
      {
        ...
        children: [
          ...
          { name: "surface", description: "+ 跟随所属 section 或 DataSurface cell。" },
        ],
      },
      { name: "presentation", description: "选择 inline、block 或 modal；只改变呈现容器，不改变非 inline 表单格式。inline 固定为 toolbar + 单 form + 无 anchor。" },
      { name: "anchor", description: "可选的 block 内容 target；只改变挂载位置，不改变 trigger 或表单格式。" },
  ...
  {
    name: "createFixedSidebarBody",
    description: "BodySurface 固定侧栏与主详情结构声明助手",
