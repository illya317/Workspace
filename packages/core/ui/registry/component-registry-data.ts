...
const EXPOSURE_BY_NAME = {
  PageSurface: { exposure: { mode: "runtime" } }, FormSurface: { exposure: { mode: "spec", entry: "PageSurface", path: "body.sections[].kind=form" } }, DataSurface: { exposure: { mode: "spec", entry: "PageSurface", path: "body.sections[].kind=data" } }, DocumentSurface: { exposure: { mode: "spec", entry: "PageSurface", path: "body.sections[].kind=document" } }, VisualizationSurface: { exposure: { mode: "spec", entry: "PageSurface", path: "body.sections[].kind=visualization" } }, BlockSurface: { exposure: { mode: "spec", entry: "PageSurface", path: "body.sections[].kind=block" } }, useFeedback: { exposure: { mode: "runtime" } },
...
const ROLE_BY_NAME = {
  ...
  createActionsSection: { role: "helper" },
  createAnalysisSection: { role: "helper" },
  createBlockSurfaceSection: { role: "helper" },
  createCreatePanelSection: { role: "helper" },
  createDocumentSection: { role: "helper" },
  createEmptySection: { role: "helper" },
  createFieldsSection: { role: "helper" },
  createFormSection: { role: "helper" },
  createSectionsSection: { role: "helper" },
  createHeadingSection: { role: "helper" },
  createInlineFieldsSection: { role: "helper" },
  createMessageSection: { role: "helper" },
  createModuleGridSection: { role: "helper" },
  createPageBody: { role: "helper" },
  createPageDataSection: { role: "helper" },
  createPageModalSection: { role: "helper" },
  createPageSurfaceProps: { role: "helper" },
  createPageTableSection: { role: "helper" },
  createPageTabsNavigation: { role: "helper" },
  createTabsNavigationSection: { role: "helper" },
  createPanelSection: { role: "helper" },
  createSectionSection: { role: "helper" },
  createSelectorPanelSection: { role: "helper" },
  createVisualizationSection: { role: "helper" },
