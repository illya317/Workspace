...
export type TemplateKind = "overview" | "table" | "split" | "form" | "analysis" | "document" | "production" | "upload";
...
export const moduleTemplates: ModuleTemplate[] = [
  {
    ...
    pages: [
      ...
      { key: "import", label: "导入", title: "财务导入", kind: "upload", group: "导入处理", routes: ["finance/import"], fields: ["导入类型", "公司", "期间", "来源", "负责人", "状态"] },
  ...
  },
  {
    ...
    pages: [
      ...
      { key: "batch-detail", label: "批次详情", title: "批次详情", kind: "split", group: "批次填写", routes: ["production/qc/batches/[batchId]"], fields: ["批号", "产品", "规格", "生产日期", "放行状态", "负责人"] },
      { key: "stage", label: "阶段详情", title: "阶段检验", kind: "split", group: "批次填写", routes: ["production/qc/batches/[batchId]/[stageKey]"], fields: ["阶段", "检验项", "方法", "结果", "判定", "复核人"] },
      { key: "test", label: "检验填写", title: "检验填写", kind: "production", group: "批次填写", routes: ["production/qc/batches/[batchId]/[stageKey]/[testName]"], fields: ["检验项", "结果", "单位", "限度", "判定", "备注"], previewAction: true },
      ...
      { key: "template-detail", label: "编辑", title: "模板维护", kind: "split", group: "检验模板", routes: ["production/qc/templates/[templateId]"], fields: ["模板名称", "产品", "版本", "阶段", "字段数", "状态"], previewAction: true },
  ...
  },
  {
    ...
    pages: [
      ...
      { key: "employee-detail", label: "员工详情", title: "员工详情", kind: "form", group: "员工资料", routes: ["hr/roster/employees/[id]"], fields: ["员工编号", "姓名", "别名", "性别", "出生年月", "农历生日", "民族", "籍贯", "政治面貌", "学历", "职称", "毕业院校", "电话", "身份证号", "参加工作时间"], previewAction: true },
  ...
  },
  {
    ...
    pages: [
      ...
      { key: "drafts", label: "草稿", title: "文档草稿", kind: "table", group: "发布流程", tableColumns: ["文档", "分类", "编辑人", "更新时间", "状态"] },
    ],
  },
  {
    key: "library",
    ...
    pages: [
      ...
      { key: "upload", label: "上传", title: "上传资料", kind: "upload", group: "上传处理", fields: ["资料类型", "目录", "保密等级", "标签", "负责人", "状态"], previewAction: true },
    ],
  },
];
