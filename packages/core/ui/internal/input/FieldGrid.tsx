...
export function FieldGridCell({
  ...
  return (
    <div className={getFieldGridCellClassName(joinClassNames(spanClass, rowSpanClass, rowSpan ? "h-full" : "", className))}>
      <div className={getFieldGridMainRowClassName(rowSpan ? "h-full" : "", mode)}>
