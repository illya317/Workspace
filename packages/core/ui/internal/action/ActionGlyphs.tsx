...
export const ACTION_GLYPH_ORDER = [
  ...
  { icon: "revise", group: "primary", subgroup: "edit", order: 11050 },
  { icon: "withdraw", group: "primary", subgroup: "edit", order: 11075 },
  ...
  { icon: "approve", group: "primary", subgroup: "confirm", order: 12075 },
  { icon: "reject", group: "primary", subgroup: "confirm", order: 12085 },
  ...
  { icon: "share", group: "extended", subgroup: "relation", order: 31200 },
  { icon: "copy", group: "extended", subgroup: "relation", order: 31300 },
...
export const ACTION_GLYPH_ACTIONS = [
  ...
  { key: "entry", label: "进入", icon: "list", variant: "secondary", section: "view" },
  { key: "read", label: "查看", icon: "view", variant: "secondary", section: "view" },
  { key: "add", label: "添加", icon: "add", variant: "primary", section: "primary" },
  { key: "send", label: "发送", icon: "send", variant: "primary", section: "primary" },
  { key: "submit", label: "提交", icon: "send", variant: "primary", section: "primary" },
  { key: "reverse", label: "撤销", icon: "withdraw", variant: "secondary", section: "edit" },
  { key: "stop", label: "停止", icon: "stop", variant: "danger", section: "action" },
  { key: "edit", label: "编辑", icon: "edit", variant: "secondary", section: "edit" },
  { key: "update", label: "编辑", icon: "edit", variant: "secondary", section: "edit" },
  { key: "revise", label: "修订", icon: "revise", variant: "secondary", section: "edit" },
  { key: "save", label: "保存", icon: "save", variant: "primary", section: "edit" },
  { key: "confirm", label: "确认", icon: "check", variant: "primary", section: "primary" },
  { key: "approve", label: "审批", icon: "approve", variant: "primary", section: "primary" },
  { key: "reject", label: "驳回", icon: "reject", variant: "danger", section: "edit" },
  ...
  { key: "back", label: "返回", icon: "back", variant: "secondary", section: "view" },
  ...
  { key: "unarchive", label: "取消归档", icon: "restore", variant: "secondary", section: "action" },
  { key: "apiUse", label: "API 调用", icon: "link", variant: "secondary", section: "action" },
  ...
  { key: "share", label: "共享", icon: "share", variant: "secondary", section: "action" },
  ...
  { key: "grant", label: "授权", icon: "permission-organization", variant: "secondary", section: "action" },
  { key: "configure", label: "配置", icon: "settings", variant: "secondary", section: "action" },
  { key: "audit", label: "审计", icon: "history", variant: "secondary", section: "view" },
  ...
  { key: "assistant", label: "页面助手", icon: "assistant", variant: "secondary", section: "action" },
  { key: "expand", label: "展开", icon: "tree-expand", variant: "secondary", section: "view" },
  { key: "collapse", label: "收起", icon: "tree-collapse", variant: "secondary", section: "view" },
...
const ACTION_GLYPH_LABEL_MATCHERS: Array<{ value: string; action: ActionGlyphActionKey }> = [
  ...
  { value: "取消归档", action: "unarchive" },
  { value: "新建", action: "create" },
  { value: "创建", action: "create" },
  { value: "新增", action: "add" },
  { value: "添加", action: "add" },
  { value: "保存", action: "save" },
  { value: "进入", action: "entry" },
  { value: "访问", action: "entry" },
  { value: "提交", action: "submit" },
  { value: "撤回", action: "reverse" },
  { value: "撤销", action: "reverse" },
  { value: "审批", action: "approve" },
  { value: "驳回", action: "reject" },
  { value: "修订", action: "revise" },
  { value: "编辑", action: "update" },
  ...
  { value: "共享", action: "share" },
  { value: "关联", action: "link" },
  { value: "复制", action: "copy" },
  { value: "授权", action: "grant" },
  { value: "配置", action: "configure" },
  { value: "管理", action: "configure" },
  { value: "审计", action: "audit" },
  { value: "API", action: "apiUse" },
