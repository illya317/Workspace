...
export const ACTION_GLYPH_ACTIONS = [
  ...
  { key: "access", label: "访问", icon: "view", variant: "secondary", section: "view" },
  ...
  { key: "withdraw", label: "撤回", icon: "restore", variant: "secondary", section: "edit" },
  { key: "stop", label: "停止", icon: "stop", variant: "danger", section: "action" },
  { key: "edit", label: "编辑", icon: "edit", variant: "secondary", section: "edit" },
  { key: "write", label: "编辑", icon: "edit", variant: "secondary", section: "edit" },
  { key: "revise", label: "修订", icon: "reclass", variant: "secondary", section: "edit" },
  { key: "save", label: "保存", icon: "save", variant: "primary", section: "edit" },
  { key: "confirm", label: "确认", icon: "check", variant: "primary", section: "primary" },
  { key: "approve", label: "审批", icon: "verified", variant: "primary", section: "primary" },
  { key: "reject", label: "驳回", icon: "x", variant: "danger", section: "edit" },
  ...
  { key: "admin", label: "管理", icon: "settings", variant: "secondary", section: "action" },
...
const ACTION_GLYPH_LABEL_MATCHERS: Array<{ value: string; action: ActionGlyphActionKey }> = [
  ...
  { value: "访问", action: "access" },
  { value: "提交", action: "submit" },
  { value: "撤回", action: "withdraw" },
