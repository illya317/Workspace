...
export const ACTION_GLYPH_ACTIONS = [
  ...
  { key: "withdraw", label: "撤回", icon: "reset", variant: "secondary", section: "edit" },
  ...
  { key: "revise", label: "修订", icon: "history", variant: "secondary", section: "edit" },
  ...
  { key: "admin", label: "管理", icon: "lock", variant: "secondary", section: "action" },
