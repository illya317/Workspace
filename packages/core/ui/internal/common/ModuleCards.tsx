  ...
  return (
    <div className="flex w-full min-w-0 flex-col items-center justify-center text-center">
      ...
      <div className="flex flex-wrap items-center justify-center gap-2">
        <h3 className="line-clamp-2 min-h-10 text-[13px] font-medium leading-5 text-slate-800 sm:min-h-0 sm:text-base sm:font-semibold sm:text-gray-800" title={textOverflowTitle(title)}>{title}</h3>
        {badge && (
