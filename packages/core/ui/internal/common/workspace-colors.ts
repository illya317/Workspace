...
export const workspaceColors = {
  ...
  primary: {
    ...
    hover: "#047857", main: "#059669", active: "#065f46", strong: "#064e3b",
  },
  info: {
...
const OUTLINED_BUTTON_TONE_CLASS: Record<BadgeTone, string> = {
  gray: "!border-slate-300 !text-slate-700 hover:!border-slate-400 hover:!text-slate-900",
  green: "!border-emerald-300 !text-emerald-700 hover:!border-emerald-500 hover:!text-emerald-800",
  blue: "!border-sky-300 !text-sky-700 hover:!border-sky-500 hover:!text-sky-800",
  red: "!border-red-300 !text-red-700 hover:!border-red-500 hover:!text-red-800",
  yellow: "!border-yellow-300 !text-yellow-700 hover:!border-yellow-500 hover:!text-yellow-800",
  orange: "!border-orange-300 !text-orange-700 hover:!border-orange-500 hover:!text-orange-800",
  emerald: "!border-emerald-300 !text-emerald-700 hover:!border-emerald-500 hover:!text-emerald-800",
  sky: "!border-sky-300 !text-sky-700 hover:!border-sky-500 hover:!text-sky-800",
  slate: "!border-slate-300 !text-slate-700 hover:!border-slate-400 hover:!text-slate-900",
  amber: "!border-amber-300 !text-amber-700 hover:!border-amber-500 hover:!text-amber-800",
};
...
export function workspaceButtonToneClassName(tone: BadgeTone) {
  return `${OUTLINED_BUTTON_TONE_CLASS[tone]} disabled:!border-slate-200 disabled:!text-slate-400`;
}
