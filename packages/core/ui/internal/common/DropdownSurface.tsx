...
import FloatingPortalSurface from "./FloatingPortalSurface";
...
export function getDropdownItemClassName({
  ...
  return `${layoutClass} min-h-11 px-4 py-2 text-left ${textClassName} transition-colors ${colorClass}`;
}
    ...
    <div ref={rootRef} className={`relative ${className}`}>
      ...
      {open && (
        <FloatingPortalSurface
          ...
          align={align}
          className={`rounded-md border border-gray-200 bg-white shadow-lg ${surfaceClassName}`}
        >
