...
export default function DataTable<T>({
  ...
  const tablePresentation = resolveTablePresentation(
    ...
    { stickyHeader: Boolean(scroll?.maxHeight) },
  );
  ...
  const desktopTable = (
    <table className={tableClassName} style={!matrix ? { minWidth: resolveStandardTableMinWidth(visible.length, scroll) } : undefined}>
      {columnWidths.length ? (
        <colgroup>
