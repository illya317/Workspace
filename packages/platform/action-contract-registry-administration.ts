...
export const ADMINISTRATION_ACTION_CONTRACT_METADATA = defineActionContractMetadataList([
  ...
  registeredLifecycle({
    key: "administration.contract.revision.create",
    activeEntity: "ContractRevision",
    operation: "custom",
  ...
  registeredLifecycle({
    key: "administration.contract.revision.publish",
    activeEntity: "ContractRevision",
    operation: "custom",
    targetIdKey: "revisionId",
    versionKey: "expectedVersion",
    auditPolicy: "event",
    domain: {
  ...
  registeredLifecycle({
    key: "administration.contract.state.transition",
    activeEntity: "ContractStateEvent",
    operation: "custom",
    targetIdKey: "contractId",
    versionKey: "expectedVersion",
    auditPolicy: "event",
  ...
  registeredLifecycle({
    key: "administration.contract.state.reverse",
    activeEntity: "ContractStateEvent",
    operation: "custom",
    targetIdKey: "eventId",
    versionKey: "expectedVersion",
