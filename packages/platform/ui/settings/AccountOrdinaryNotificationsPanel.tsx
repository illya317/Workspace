  ...
  return (
    <PageSurface
      ...
      body={createBodySplitSection({
        left: createPageBody([list]),
        right: createPageBody([detail]),
        side: { label: "收件箱", open: true, drawerOpen: false, onOpenChange: () => undefined, onDrawerOpenChange: () => undefined, showControls: false },
        layout: { ratio: [3, 7] },
      })}
    />
  );
