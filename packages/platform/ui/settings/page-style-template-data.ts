...
export const moduleTemplates: ModuleTemplate[] = [
  ...
  },
  {
    ...
    pages: [
      ...
      { key: "works", label: "待办", title: "待办任务", kind: "table", section: "工作清单", group: "任务台账", routes: ["/work/tasks"], tableColumns: ["任务", "负责人", "计划", "优先级", "截止日", "状态"] },
      { key: "works-done", label: "已完成", title: "已完成任务", kind: "table", section: "工作清单", group: "任务台账", routes: ["/work/tasks"], tableColumns: ["任务", "负责人", "计划", "完成日期", "确认人", "状态"] },
      { key: "reports", label: "周报", title: "周报记录", kind: "table", section: "工作汇报", group: "汇报台账", routes: ["/work/reports"], tableColumns: ["周期", "填报人", "计划", "完成率", "风险", "状态"] },
      { key: "reports-month", label: "月报", title: "月报记录", kind: "table", section: "工作汇报", group: "汇报台账", routes: ["/work/reports"], tableColumns: ["月份", "填报人", "计划", "完成率", "风险", "状态"] },
