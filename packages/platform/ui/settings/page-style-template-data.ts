...
export const moduleTemplates: ModuleTemplate[] = [
  ...
  },
  {
    ...
    entryRoutes: ["/work"],
    pages: [
      { key: "plans", label: "现用", title: "计划列表", kind: "split", section: "工作计划", group: "计划台账", routes: ["/work/plans"], fields: ["计划编码", "计划名称", "主导部门", "负责人", "预算金额", "风险等级"], embedded: { title: "计划详情", kind: "form", fields: ["计划编码", "计划名称", "主导部门", "负责人", "预算金额", "开始日期", "结束日期", "状态", "备注"], routes: ["/work/plans/[id]"] } },
      { key: "plans-archived", label: "归档", title: "归档计划", kind: "table", section: "工作计划", group: "计划台账", routes: ["/work/plans"], tableColumns: ["计划编码", "计划名称", "归档日期", "主导部门", "负责人", "状态"] },
      { key: "works", label: "待办", title: "待办任务", kind: "table", section: "工作清单", group: "任务台账", routes: ["/works"], tableColumns: ["任务", "负责人", "计划", "优先级", "截止日", "状态"] },
      { key: "works-done", label: "已完成", title: "已完成任务", kind: "table", section: "工作清单", group: "任务台账", routes: ["/works"], tableColumns: ["任务", "负责人", "计划", "完成日期", "确认人", "状态"] },
      { key: "reports", label: "周报", title: "周报记录", kind: "table", section: "工作汇报", group: "汇报台账", routes: ["/reports"], tableColumns: ["周期", "填报人", "计划", "完成率", "风险", "状态"] },
      { key: "reports-month", label: "月报", title: "月报记录", kind: "table", section: "工作汇报", group: "汇报台账", routes: ["/reports"], tableColumns: ["月份", "填报人", "计划", "完成率", "风险", "状态"] },
  ...
  },
  {
    ...
    pages: [
      { key: "contracts", label: "现用", title: "合同列表", kind: "table", section: "合同台账", group: "合同台账", routes: ["/contracts"], tableColumns: ["合同编号", "合同名称", "相对方", "金额", "到期日", "状态"], embedded: { title: "合同详情", kind: "form", fields: ["合同编号", "合同名称", "相对方", "合同金额", "签署日期", "到期日期", "负责人", "状态", "备注"], routes: ["/contracts/[id]"] } },
      { key: "contracts-expiring", label: "到期", title: "即将到期合同", kind: "table", section: "合同台账", group: "合同台账", routes: ["/contracts"], tableColumns: ["合同编号", "合同名称", "到期日", "负责人", "续签状态", "风险"] },
      { key: "contracts-archived", label: "归档", title: "归档合同", kind: "table", section: "合同台账", group: "合同台账", routes: ["/contracts"], tableColumns: ["合同编号", "合同名称", "归档日期", "相对方", "负责人", "状态"] },
