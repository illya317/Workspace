...
const baseModuleTemplates: ModuleTemplate[] = [
  ...
  },
  {
    ...
    pages: [
      ...
      { key: "works", label: "待办", title: "待办任务", kind: "table", section: "工作计划", group: "任务台账", routes: ["/work/tasks"], tableColumns: ["任务", "负责人", "项目", "优先级", "截止日", "状态"] },
      { key: "works-done", label: "已完成", title: "已完成任务", kind: "table", section: "工作计划", group: "任务台账", routes: ["/work/tasks"], tableColumns: ["任务", "负责人", "项目", "完成日期", "确认人", "状态"] },
