...
export default function AgentMessageList({ messages, mood, loading, hints, hintsLoaded, onHintClick, onOpenDrawer }: Props) {
          ...
          <div key={msg.id} className={`flex ${msg.role === "user" ? "justify-end" : "justify-start"}`}>
            ...
            <div className="max-w-[82%]">
              <div className={`rounded-xl px-3 py-2 text-sm whitespace-pre-wrap ${
                ...
                : msg.role === "system" ? "bg-amber-50 text-amber-700 border border-amber-200"
