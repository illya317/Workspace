...
export const BUSINESS_ACTION_REGISTRATIONS = [
  ...
  },
  {
    ...
    targetKind: "Employee",
    directPermissionAction: "update",
    apiRoutes: [route("PUT", "/api/modules/hr/roster/employees/:id")],
    notes: "Field-level employee update remains permission-only until HR employee approval adapter and inline status UI land.",
  },
