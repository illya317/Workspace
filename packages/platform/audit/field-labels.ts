export const FIELD_LABELS: Record<string, string> = {
  ...
  subjectType: "主体类型", relatedPartyType: "关系性质", classification: "业务分类",
  identityNumber: "证件号码", legalRepresentative: "法定代表人", contactPerson: "联系人",
  email: "邮箱", bankAccount: "银行账号", address: "地址",
  invoiceTitle: "开票抬头", invoiceAddressPhone: "开票地址及电话", settlementTerms: "结算条件",
  creditLimit: "信用额度", creditDays: "信用期限", taxRate: "税率", remark: "备注",
  queryGroup: "查询分组", hierarchyKind: "组织体系", level: "层级", parentId: "上级",
