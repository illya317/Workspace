...
const WORK_RELATION_REGISTRATIONS = [
  ...
  { key: "work.projects.leadingDepartment", scope: "work", source: { entity: "Project", field: "leadingDepartmentId" }, target: "department", targetLabel: "归口部门", nullable: true, businessRequired: "required", permission: { resourceKey: "work.projects", action: "entry" } },
  ...
  { key: "work.projects.member.project", scope: "work", usage: "both", semantics: "snapshot", source: { entity: "EmployeeProject", field: "projectId" }, target: "project", nullable: false, lifecycle: { targetDelete: "block", targetArchive: "retain", targetRestore: "retain", sourceRelationChange: "retain" }, adapterKey: "work.project.memberships", permission: { resourceKey: "work.projects", action: "entry" } },
