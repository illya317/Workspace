...
export const registeredModuleDefinitions = [
  ...
  },
  {
    ...
    apiRoutes: [
      { method: "GET", pathPrefix: "/api/agent", access: "protected", migrationNote: "Legacy agent URL; migrate to /api/modules/agent." },
      { method: "POST", pathPrefix: "/api/agent", access: "protected", migrationNote: "Legacy agent URL; migrate to /api/modules/agent." },
    ],
  },
  {
