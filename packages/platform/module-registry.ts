  ...
  },
  {
    ...
    moduleDef: {
      ...
      children: [
        ...
        { key: "api", label: "API 接入", desc: "Open API Client、Scope 授权和调用日志", href: "/settings/api", resourceKey: "settings.api", resourceMaxRoleKey: "write", apiPrefixes: ["/api/settings/api"] },
      ],
    },
