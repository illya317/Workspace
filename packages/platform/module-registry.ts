...
export const registeredModuleDefinitions = [
  ...
  },
  {
    ...
    moduleDef: {
      ...
      children: [
        ...
        { key: "qcTemplates", label: "检验模板", desc: "模板结构浏览、版式预览、反馈收集", href: "/production/qc-templates", iconKey: "qcTemplates", color: "cyan", resourceKey: "production.qcTemplates", apiPrefixes: ["/api/modules/production/qc-templates"] },
      ],
    },
  ...
  },
  {
    ...
    moduleDef: {
      ...
      children: [
        { key: "investors", label: "投资人关系", desc: "投资人信息、沟通记录", href: "/external/investors", iconKey: "investors", color: "orange", resourceKey: "external.investors", resourceMaxRoleKey: "delete", lifecycleStatus: "workspace-owned", noApiReason: "当前仅提供页面入口，暂无独立 API" },
        { key: "customers", label: "客户管理", desc: "客户信息、跟进记录", href: "/external/customers", iconKey: "users", color: "orange", resourceKey: "external.customers", resourceMaxRoleKey: "delete", lifecycleStatus: "workspace-analysis", noApiReason: "规划中页面，暂无业务 API" },
        { key: "suppliers", label: "供应商管理", desc: "供应商信息、采购记录", href: "/external/suppliers", iconKey: "suppliers", color: "orange", resourceKey: "external.suppliers", resourceMaxRoleKey: "delete", lifecycleStatus: "workspace-analysis", noApiReason: "规划中页面，暂无业务 API" },
      ],
    },
  ...
  },
  {
    ...
    apiRoutes: [
      ...
      { method: "GET", pathPrefix: "/api/settings/ui-components/verified", access: "protected", resourceKey: "settings.admin", action: "access" },
      { method: "POST", pathPrefix: "/api/settings/ui-components/verified", access: "protected", resourceKey: "settings.admin", action: "write" },
    ],
    apiGuards: [
