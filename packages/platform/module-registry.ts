...
export const registeredModuleDefinitions = [
  ...
  },
  {
    ...
    apiRoutes: [
      { method: "GET", pathPrefix: "/api/agent", access: "protected", migrationNote: "Legacy headless assistant URL retained under agent.assistant." },
      { method: "POST", pathPrefix: "/api/agent", access: "protected", migrationNote: "Legacy headless assistant URL retained under agent.assistant." },
    ],
  },
  {
