...
export const ADDITIONAL_BUSINESS_ACTION_REGISTRATIONS = [
  ...
  { ...CAPITAL_SECURITIES_GOVERNANCE, ...PERMISSION_ONLY, key: "capitalSecurities.governance.consolidationScope.update", label: "调整并表范围", writeKind: "update", targetKind: "ShareCapitalEvent", directPermissionAction: "update", apiRoutes: [route("POST", "/api/modules/capitalSecurities/governance/ownership-interests/consolidation")] },
] as const;
