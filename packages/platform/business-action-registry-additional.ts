...
export const ADDITIONAL_BUSINESS_ACTION_REGISTRATIONS = [
  ...
  { ...FINANCE_STATEMENTS, ...PERMISSION_ONLY, key: "finance.statements.exchangeRate.review", label: "独立复核报表汇率证据", writeKind: "approve", targetKind: "FinanceStatementExchangeRate", directPermissionAction: "approve", apiRoutes: [route("POST", "/api/modules/finance/statements/consolidation/exchange-rates/:rateId/review")] },
  ...
  { ...FINANCE_STATEMENTS, ...PERMISSION_ONLY, key: "finance.statements.consolidationEntry.save", label: "编制合并抵销分录", writeKind: "save", targetKind: "FinanceConsolidationEntry", directPermissionAction: "update", apiRoutes: [route("POST", "/api/modules/finance/statements/consolidation/batches/:batchId/entries")] },
