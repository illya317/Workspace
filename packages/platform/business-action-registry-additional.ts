...
export const ADDITIONAL_BUSINESS_ACTION_REGISTRATIONS = [
  ...
  },
  {
    ...
    directPermissionAction: "update",
    apiRoutes: [route("PATCH", "/api/modules/library/basic-info/documents/:id", "Ordinary title/summary/tag/category metadata fields require update.")],
  },
  {
    ...LIBRARY_BASIC_INFO,
    ...PERMISSION_ONLY,
  ...
  { ...FINANCE_LEDGER, ...PERMISSION_ONLY, key: "finance.ledger.balance.reconcile", label: "导入余额校准", writeKind: "import", targetKind: "FinanceBalanceReconcile", directPermissionAction: "import", apiRoutes: [route("POST", "/api/modules/finance/ledger/balances/reconcile")] },
  ...
  { ...FINANCE_LEDGER, ...PERMISSION_ONLY, key: "finance.ledger.reclassRule.delete", label: "清除重分类规则", writeKind: "delete", targetKind: "FinanceReclassRule", directPermissionAction: "revise", apiRoutes: [route("DELETE", "/api/modules/finance/ledger/reclass-rules/:id")] },
