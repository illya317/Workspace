...
export const ADDITIONAL_BUSINESS_ACTION_REGISTRATIONS = [
  ...
  { ...FINANCE_STATEMENTS, ...PERMISSION_ONLY, key: "finance.statements.sourcePackage.upload", label: "上传个别三表来源包", writeKind: "import", targetKind: "FinanceStatementSourcePackage", directPermissionAction: "create", apiRoutes: [route("POST", "/api/modules/finance/statements/consolidation/source-packages")] },
  { ...FINANCE_STATEMENTS, ...PERMISSION_ONLY, key: "finance.statements.sourcePackage.submit", label: "提交个别三表来源包", writeKind: "submit", targetKind: "FinanceStatementSourcePackage", directPermissionAction: "submit", apiRoutes: [route("POST", "/api/modules/finance/statements/consolidation/source-packages/:id/submit")] },
  ...
  { ...FINANCE_STATEMENTS, ...PERMISSION_ONLY, key: "finance.statements.consolidationSources.save", label: "冻结个别报表来源", writeKind: "save", targetKind: "FinanceConsolidationSourceSnapshot", directPermissionAction: "update", apiRoutes: [route("PUT", "/api/modules/finance/statements/consolidation/batches/:batchId/sources")] },
  ...
  { ...CAPITAL_SECURITIES_GOVERNANCE, ...PERMISSION_ONLY, key: "capitalSecurities.governance.companyRelation.create", label: "新建股权关系", writeKind: "create", targetKind: "CompanyRelation", directPermissionAction: "create", apiRoutes: [route("POST", "/api/modules/capitalSecurities/governance/company-relations")] },
  { ...CAPITAL_SECURITIES_GOVERNANCE, ...PERMISSION_ONLY, key: "capitalSecurities.governance.companyRelation.update", label: "更新股权关系", writeKind: "update", targetKind: "CompanyRelation", directPermissionAction: "update", apiRoutes: [route("PUT", "/api/modules/capitalSecurities/governance/company-relations")] },
  { ...CAPITAL_SECURITIES_GOVERNANCE, ...PERMISSION_ONLY, key: "capitalSecurities.governance.companyRelation.delete", label: "删除股权关系", writeKind: "delete", targetKind: "CompanyRelation", directPermissionAction: "delete", apiRoutes: [route("DELETE", "/api/modules/capitalSecurities/governance/company-relations/:id")] },
] as const;
