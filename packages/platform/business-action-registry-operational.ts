...
export const OPERATIONAL_BUSINESS_ACTION_REGISTRATIONS = [
  ...
  { ...HR_ROSTER, ...PERMISSION_ONLY, key: "hr.roster.employmentAgreement.command", label: "执行员工协议生命周期命令", writeKind: "save", targetKind: "EmploymentAgreement", directPermissionAction: "update", apiRoutes: [route("POST", "/api/modules/hr/roster/employee-profiles/:id/agreements")] },
