...
export const OPERATIONAL_BUSINESS_ACTION_REGISTRATIONS = [
  ...
  { ...HR_ROSTER, ...PERMISSION_ONLY, key: "hr.roster.companyRelation.update", label: "更新公司关系", writeKind: "update", targetKind: "CompanyRelation", directPermissionAction: "update", apiRoutes: [route("PUT", "/api/modules/hr/roster/company-relations"), route("PUT", "/api/modules/hr/roster/company-relations/:id")] },
