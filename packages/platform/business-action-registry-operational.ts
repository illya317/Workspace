...
export const OPERATIONAL_BUSINESS_ACTION_REGISTRATIONS = [
  ...
  { ...HR_ROSTER, ...PERMISSION_ONLY, key: "hr.roster.employeeContract.update", label: "更新员工合同", writeKind: "update", targetKind: "EmployeeContract", directPermissionAction: "update", apiRoutes: [route("PUT", "/api/modules/hr/roster/contracts/:id")] },
  ...
  { ...HR_ROSTER, ...PERMISSION_ONLY, key: "hr.roster.edp.update", label: "更新员工部门岗位记录", writeKind: "update", targetKind: "EmployeeDepartmentPosition", directPermissionAction: "update", apiRoutes: [route("PUT", "/api/modules/hr/roster/edps/:id")] },
  ...
  { ...HR_ROSTER, ...PERMISSION_ONLY, key: "hr.roster.employment.update", label: "更新任职记录", writeKind: "update", targetKind: "Employment", directPermissionAction: "update", apiRoutes: [route("PUT", "/api/modules/hr/roster/employments/:id")] },
