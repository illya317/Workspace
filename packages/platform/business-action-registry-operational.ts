...
export const OPERATIONAL_BUSINESS_ACTION_REGISTRATIONS = [
  ...
  { ...HR_ROSTER, ...PERMISSION_ONLY, key: "hr.roster.employeePeriod.revise", label: "修订人员周期", writeKind: "revise", targetKind: "EmployeeTemporalPeriod", directPermissionAction: "revise", apiRoutes: [route("POST", "/api/modules/hr/roster/employee-profiles/:id/period-revisions")] },
