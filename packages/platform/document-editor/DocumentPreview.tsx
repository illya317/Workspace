            ...
            {row.cells.map((cell, cellIndex) => {
              ...
              return (
                <Cell
                  ...
                  className={`min-w-0 whitespace-normal [overflow-wrap:anywhere] border border-slate-500 px-2 py-1 text-center align-middle ${cell.bold || cell.header ? "font-semibold" : "font-normal"} ${cellSemanticClassName(cell)} ${annotationClassName(cell.metadata)}`}
