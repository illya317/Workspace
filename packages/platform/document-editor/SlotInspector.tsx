...
/** @ui-structural-declaration Complete slot-inspector field groups. */
    ...
    fields: [
      selectedType === "signatureSlot"
        ...
        : {
            key: "type",
            label: "字段角色",
            spec: { valueType: "string", control: "choice", options: { source: "static", items: slotKindOptions(), searchPlaceholder: "选择字段角色" }, state: disabledState },
      ...
      ...(supportsInputMethod(attrs, selectedType) ? [{
        key: "inputMethod",
        label: "输入方式",
        spec: { valueType: "string", control: "choice", options: { source: "static", items: inputMethodOptions(), searchPlaceholder: "选择输入方式" }, state: disabledState },
...
export function collectFormulaDisplayTokens(document: EditorDocument, fieldModel?: FieldModel, dryingWeightMultipliers: Record<string, number> = {}) {
  ...
  return [...directTokens, ...refTokens, ...collectFieldModelFormulaTokens(fieldModel, byFieldKey, dryingWeightMultipliers)];
}
