import type { EditorSlotInline, EditorSlotType, FieldDefinition } from "@workspace/platform/document-editor/types";
import { normalizeInputAttrs } from "@workspace/platform/document-editor/slot-input-semantics";
import {
  failCommand,
  okCommand,
