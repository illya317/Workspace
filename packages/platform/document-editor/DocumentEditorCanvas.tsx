...
export default function DocumentEditorCanvas({
  ...
  const formulaTokens = useMemo(
    () => collectFormulaDisplayTokens(document, fieldModel, tenantConfig.docs.formulaRules.dryingWeightMultipliers),
    [document, fieldModel, tenantConfig.docs.formulaRules.dryingWeightMultipliers],
  );
