...
const REQUIRED_DELEGATES = ["financeBalanceSnapshot", "financeBalanceSnapshotRow", "financeAssetCard", "inventoryItem", "inventoryLedgerEntry", "externalParty", "externalPartyRole", "agentSession", "agentProposal", "openApiClient", "notification", "workReport", "workReportItem", "approvalRequest", "approvalEvent", "workflowPolicy", "permissionGrantLedgerEvent"] as const;
