...
const REQUIRED_DELEGATES = ["financeBalanceSnapshot", "financeBalanceSnapshotRow", "financeAssetCard", "inventoryItem", "inventoryLedgerEntry", "externalParty", "externalPartyRole", "agentProfile", "agentRuntimeBinding", "agentSession", "agentProposal", "agentRun", "openApiClient", "notification", "workReport", "workReportItem", "approvalRequest", "approvalEvent", "workflowPolicy", "permissionGrantLedgerEvent"] as const;
