...
const REQUIRED_DELEGATES = ["financeBalanceSnapshot", "financeBalanceSnapshotRow", "financeAssetCard", "inventoryItem", "inventoryLedgerEntry", "party", "partyNameHistory", "externalPartyRole", "ownershipInterest", "shareCapitalSnapshotPosition", "shareholderGroup", "shareholderGroupMembership", "agentProfile", "agentRuntimeBinding", "agentSession", "agentProposal", "agentRun", "openApiClient", "notification", "notificationDefinition", "notificationDefinitionRevision", "notificationPublication", "notificationDelivery", "notificationChannelEndpoint", "notificationDeliveryAttempt", "notificationDeliveryWorkerRequest", "relationPolicyConfig", "relationPolicyRevision", "workReport", "workReportItem", "approvalRequest", "approvalEvent", "workflowPolicy", "permissionGrantLedgerEvent", "dataQualityRun", "dataQualityCheckState", "dataQualityFinding", "dataQualityNotificationDelivery", "dataQualityEvaluationRequest"] as const;
