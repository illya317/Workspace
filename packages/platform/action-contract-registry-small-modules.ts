...
export const SMALL_MODULE_ACTION_CONTRACT_METADATA = defineActionContractMetadataList([
  ...
  registeredGovernance({
    key: "capitalSecurities.governance.companyRelation.create",
    activeEntity: "CompanyRelation",
    subject: "relationship",
    scope: "organization",
    domain: d("packages/capital-securities/server/domain/company-governance-validation.buildCompanyRelationCreateCommand", "packages/capital-securities/server/company-governance.createCompanyRelation"),
  }),
  registeredGovernance({
    key: "capitalSecurities.governance.companyRelation.update",
    activeEntity: "CompanyRelation",
    subject: "relationship",
    scope: "organization",
    domain: d("packages/capital-securities/server/domain/company-governance-validation.buildCompanyRelationUpdateCommand", "packages/capital-securities/server/company-governance.updateCompanyRelation"),
  }),
  registeredLifecycle({
    key: "capitalSecurities.governance.companyRelation.delete",
    activeEntity: "CompanyRelation",
    operation: "delete",
    versionKey: "expectedVersion",
    deleteMode: "hard",
    referencePolicy: "domain",
    domain: d("packages/capital-securities/server/domain/company-governance-validation.validateCompanyRelationDeleteCommand", "packages/capital-securities/server/company-governance.deleteCompanyRelation"),
  }),
]);
