...
export const WORK_DIRECT_ACTION_CONTRACT_METADATA = defineActionContractMetadataList([
  ...
  registeredWrite({ key: "work.tasks.okr_control.save", activeEntity: "WorkOkrControlPolicy", domain: d("packages/work/server/domain/work-okr-control-validation.validateWorkOkrControlCommand", "packages/work/server/work-okr-control.updateWorkOkrControlSettings"), shape: "change_set", commitMode: "native_transition" }),
