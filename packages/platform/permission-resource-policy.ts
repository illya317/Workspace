...
const BASE_PERMISSION_RESOURCE_ACTION_POLICIES = [
  ...
  { resourceKey: "finance.statements", status: "business", supportedActions: ["entry", "read", "create", "update", "delete", "submit", "approve", "reject", "lock", "unlock"], ancestorInheritedActions: ["entry", "read", "create", "update", "delete"], explicitOnlyActions: ["submit", "approve", "reject", "lock", "unlock"], notes: "The single financial-statements resource owns individual reports and consolidation batches. create/update prepare evidence and workpapers; submit/approve/reject separate preparation from review; lock/unlock governs the exact consolidated snapshot. Ledger reclassification remains on finance.ledger." },
