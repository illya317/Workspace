...
const BASE_PERMISSION_RESOURCE_ACTION_POLICIES = [
  ...
  { resourceKey: "capitalSecurities.governance", status: "business", supportedActions: ["entry", "read", "create", "update"], ancestorInheritedActions: ["entry", "read", "create", "update"], explicitOnlyActions: [], notes: "create/update cover G-line organizations, legal-company master data, and governed consolidation-control events. OwnershipInterest remains a read-only projection; Position, position-description, and employee-assignment writes remain under HR." },
