...
const BASE_PERMISSION_RESOURCE_ACTION_POLICIES = [
  ...
  { resourceKey: "capitalSecurities.governance", status: "business", supportedActions: ["entry", "read", "create", "update", "delete"], ancestorInheritedActions: ["entry", "read", "create", "update", "delete"], explicitOnlyActions: [], notes: "create/update cover G-line organizations, legal-company master data, and equity/control relationships; delete is limited to versioned CompanyRelation removal. Position, position-description, and employee-assignment writes remain under HR." },
