...
const BASE_PERMISSION_RESOURCE_ACTION_POLICIES = [
  ...
  { resourceKey: "finance.ledger", status: "business", supportedActions: ["entry", "read", "create", "update", "delete", "revise", "export"], ancestorInheritedActions: ["entry", "read", "create", "update", "delete"], explicitOnlyActions: ["revise", "export"] },
  { resourceKey: "finance.statements", status: "business", supportedActions: ["entry", "read", "create", "update", "delete"], ancestorInheritedActions: ["entry", "read", "create", "update", "delete"], explicitOnlyActions: [], notes: "The single financial-statements resource owns report reads plus statement-line and account-mapping configuration; ledger reclassification remains on finance.ledger." },
  ...
  { resourceKey: "inventory.operations", status: "business", supportedActions: ["entry", "read", "create", "update", "reverse", "import", "export", "lock", "unlock"], ancestorInheritedActions: ["entry", "read", "create", "update"], explicitOnlyActions: ["reverse", "import", "export", "lock", "unlock"], notes: "create=物料与单据草稿，update=单据过账，reverse=反向流水冲销，lock/unlock=期间结转治理。" },
  { resourceKey: "external", status: "container", supportedActions: ["entry", "read", "create", "update", "delete"], ancestorInheritedActions: [], explicitOnlyActions: [], notes: "External owns customer and supplier master data; each role can contain organizations or individuals." },
