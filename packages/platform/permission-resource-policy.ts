...
const BASE_PERMISSION_RESOURCE_ACTION_POLICIES = [
  ...
  { resourceKey: "finance.statements", status: "business", supportedActions: ["entry", "read", "create", "update", "delete", "submit", "approve", "reject", "export", "lock", "unlock", "import"], ancestorInheritedActions: ["entry", "read", "create", "update", "delete"], explicitOnlyActions: ["submit", "approve", "reject", "export", "lock", "unlock", "import"], notes: "The single financial-statements resource owns individual reports, one-off consolidation scope selections, and consolidation batches. create/update prepare evidence, workpapers, and the selected entities for one report generation; submit/approve/reject separate preparation from review; export downloads the current three-statement workbook; lock/unlock governs the exact consolidated snapshot. Ledger reclassification remains on finance.ledger. import is explicit-only and covers only comparison evidence workbook upload; it never authorizes overwriting statements or posting accounting facts, and upload still requires create alongside import." },
  ...
  { resourceKey: "finance.budget", status: "business", supportedActions: ["entry", "read", "create", "approve"], ancestorInheritedActions: ["entry", "read", "create"], explicitOnlyActions: ["approve"] },
  ...
  { resourceKey: "capitalSecurities.marketIntelligence", status: "business", supportedActions: ["entry", "read"], ancestorInheritedActions: ["entry", "read"], explicitOnlyActions: [], notes: "Read-only market catalog and quote aggregation. Browser-local watchlists do not create a server-side business record; provider adapters must not bypass upstream market-data licensing." },
  { resourceKey: "capitalSecurities.investors", status: "business", supportedActions: ["entry", "read", "create", "update", "delete"], ancestorInheritedActions: ["entry", "read", "create", "update", "delete"], explicitOnlyActions: [], notes: "Captables remain read-only temporal projections over the capital ledger. create/update/delete only maintain shareholder relationship profiles and soft-archived due-diligence participant records; they never mutate calculated ownership amounts or ratios." },
  { resourceKey: "capitalSecurities.investments", status: "business", supportedActions: ["entry", "read", "create", "update", "import"], ancestorInheritedActions: ["entry", "read", "create", "update"], explicitOnlyActions: ["import"], notes: "Investee profiles, governance meetings, diligence findings, contract obligations, monitoring records, and stable Library document links. Company, Party, ownership facts, immutable files, OCR, chunks, and embeddings remain authoritative in their owner modules." },
  ...
  { resourceKey: "news", status: "business", supportedActions: ["entry", "read", "create"], ancestorInheritedActions: ["entry", "read", "create"], explicitOnlyActions: [], notes: "All authenticated users receive create access for their own like or dislike preference on external news items." },
  ...
  { resourceKey: "settings.notifications", status: "capability", supportedActions: ["read", "configure", "create", "apiUse", "audit"], ancestorInheritedActions: [], explicitOnlyActions: ["read", "configure", "create", "apiUse", "audit"], notes: "Notification definitions, publication, and audit are independently granted; API publication always requires both create and apiUse." },
  { resourceKey: "settings.governance", status: "business", supportedActions: ["entry", "read", "configure", "audit"], ancestorInheritedActions: ["entry", "read"], explicitOnlyActions: ["configure", "audit"], notes: "Platform governance owns Core UI declarations, database relations, module runtime controls, source analysis, and operational records." },
