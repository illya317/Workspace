...
const BASE_PERMISSION_RESOURCE_ACTION_POLICIES = [
  ...
  { resourceKey: "capitalSecurities.governance", status: "business", supportedActions: ["entry", "read", "create", "update"], ancestorInheritedActions: ["entry", "read", "create", "update"], explicitOnlyActions: [], notes: "create/update cover G-line organizations and legal-company master data. Equity/control relationships are projected from governed capital data releases rather than edited through governance APIs. Position, position-description, and employee-assignment writes remain under HR." },
