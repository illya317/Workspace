...
export const PERMISSION_API_ACTION_POLICIES = [
  ...
  { method: "GET", pathPrefix: "/api/modules/library/basic-info/documents", resourceKey: "library.basicInfo", additionalAction: "export", pathPattern: /^\/api\/modules\/library\/basic-info\/documents\/[^/]+\/download$/ },
  { method: "POST", pathPrefix: "/api/modules/library/basic-info/scan", resourceKey: "library.basicInfo", additionalAction: "import" },
  { method: "POST", pathPrefix: "/api/modules/library/basic-info/generated-sources", resourceKey: "library.basicInfo", additionalAction: "import", pathPattern: /^\/api\/modules\/library\/basic-info\/generated-sources\/[^/]+\/generate$/ },
