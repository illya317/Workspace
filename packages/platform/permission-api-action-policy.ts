...
export const PERMISSION_API_ACTION_POLICIES = [
  ...
  { method: "POST", pathPrefix: "/api/modules/hr/roster/employee-profiles", requiredActions: ["revise"], pathPattern: /^\/api\/modules\/hr\/roster\/employee-profiles\/[^/]+\/period-revisions$/, notes: "Employment and EDP period corrections require the dedicated revise action and domain timeline validation." },
