...
export const PERMISSION_API_ACTION_POLICIES = [
  ...
  { method: "POST", pathPrefix: "/api/modules/finance/statement-review/reviews", requiredActions: ["approve"], pathPattern: /^\/api\/modules\/finance\/statement-review\/reviews\/[^/]+\/confirm$/ },
  ...
  { method: "POST", pathPrefix: "/api/modules/finance/statement-review/reviews", requiredActions: ["create"], pathPattern: /^\/api\/modules\/finance\/statement-review\/reviews$/ },
  { method: "GET", pathPrefix: "/api/modules/library/basic-info", requiredActions: ["export"], pathPattern: /^\/api\/modules\/library\/basic-info\/(?!(?:categories|directories|documents|generated-sources|scan)(?:\/|$)).+$/ },
  ...
  { method: "DELETE", pathPrefix: "/api/modules/library/basic-info/documents", requiredActions: ["archive"] },
