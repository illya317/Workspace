...
export const FINANCE_DIRECT_ACTION_CONTRACT_METADATA = defineActionContractMetadataList([
  ...
  registeredWrite({ key: "finance.ledger.reclassRule.save", activeEntity: "FinanceReclassRule", domain: d(routeCommand("buildUpsertReclassRuleRouteCommand"), routeCommand("executeUpsertReclassRuleRouteCommand")), shape: "full_record", target: "mixed", commitMode: "native_transition" }),
  registeredLifecycle({ key: "finance.ledger.reclassRule.delete", activeEntity: "FinanceReclassRule", operation: "delete", domain: d(routeCommand("buildFinanceRouteIdCommand"), routeCommand("executeDeleteReclassRuleRouteCommand")), referencePolicy: "domain" }),
