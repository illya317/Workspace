...
export const FINANCE_DIRECT_ACTION_CONTRACT_METADATA = defineActionContractMetadataList([
  ...
  registeredWrite({ key: "finance.assets.assetPeriod.recalculate", activeEntity: "FinanceAssetPeriodEntry", domain: d("packages/finance/server/assets/route-commands.buildRecalculateFinanceAssetPeriodRouteCommand", "packages/finance/server/assets/route-commands.executeRecalculateFinanceAssetPeriodCommand"), shape: "change_set", target: "mixed", commitMode: "native_transition" }),
  registeredWrite({ key: "finance.assets.assetPeriod.linkVoucher", activeEntity: "FinanceAssetPeriodEntry", domain: d("packages/finance/server/assets/route-commands.buildLinkFinanceAssetPeriodVoucherRouteCommand", "packages/finance/server/assets/route-commands.executeLinkFinanceAssetPeriodVoucherRouteCommand"), shape: "change_set", target: "mixed", commitMode: "native_transition" }),
  registeredWrite({ key: "finance.assets.acquisitionEvidence.confirm", activeEntity: "FinanceAssetAcquisitionEvidence", domain: d("packages/finance/server/assets/route-commands.buildConfirmFinanceAssetAcquisitionEvidenceRouteCommand", "packages/finance/server/assets/route-commands.executeConfirmFinanceAssetAcquisitionEvidenceRouteCommand"), shape: "full_record", target: "new_record", commitMode: "native_transition" }),
  registeredWrite({ key: "finance.assets.impairmentAssessment.confirm", activeEntity: "FinanceAssetImpairmentAssessment", domain: d("packages/finance/server/assets/route-commands.buildConfirmFinanceAssetImpairmentAssessmentRouteCommand", "packages/finance/server/assets/route-commands.executeConfirmFinanceAssetImpairmentAssessmentRouteCommand"), shape: "full_record", target: "mixed", commitMode: "native_transition" }),
  registeredWrite({ key: "finance.assets.disposal.confirm", activeEntity: "FinanceAssetDisposal", domain: d("packages/finance/server/assets/route-commands.buildConfirmFinanceAssetDisposalRouteCommand", "packages/finance/server/assets/route-commands.executeConfirmFinanceAssetDisposalRouteCommand"), shape: "full_record", target: "new_record", commitMode: "native_transition" }),
  {
    ...registeredActionFacts("finance.assets.workspace.export"),
    kind: "exchange",
    payload: { cardinality: "batch", shape: "full_record", target: "mixed", notes: "按资产会计当前公司、期间、视图和关键词筛选导出全部匹配行。" },
    exchange: { direction: "export", transport: "file", result: "file", contentTypes: ["application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"] },
    domain: { bindings: [{ validatorKey: "packages/finance/server/assets/export-route-commands.buildFinanceAssetExportCommand", executeKey: "packages/finance/server/assets/export-route-commands.executeFinanceAssetExportCommand" }] },
  },
