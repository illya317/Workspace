...
export default function NewsWorkspaceClient() {
  ...
  const toolbarItems: SurfaceToolbarItems = [
    ...
    { kind: "action-group", key: "news-actions", actions: [
      { key: "refresh", kind: "refresh", label: "刷新简报", disabled: loading, onClick: () => void loadWorkspace() },
      ...(workspace.briefing.sourceUrl ? [{ key: "source", kind: "open" as const, label: "打开简报源", onClick: () => openExternal(workspace.briefing.sourceUrl) }] : []),
    ] },
  ];
