...
import type { BodySurfaceSectionSpec, PageSurfaceTabBarItemSpec } from "@workspace/core/ui";
...
export function getFinancePageViewTabs(activeNav: string, user: SessionUser): PageSurfaceTabBarItemSpec[] {
