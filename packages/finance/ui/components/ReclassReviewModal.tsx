...
import { createFieldsSection, createPageModalSection } from "@workspace/core/ui";
      ...
      createFieldsSection("reclass-review-form", [
        ...
        ...(item.description ? [{ kind: "readonly" as const, key: "description", label: "摘要", value: item.description }] : []),
        {
          ...
          spec: {
            valueType: "string",
            control: "choice",
            options: { source: "static",items: searchableAccountOptions, visibleCount: 5 },
          },
          value: targetAccount,
        ...
        actions: [
          { key: "cancel", action: "cancel", label: "取消", onClick: handleClose },
          { key: "submit", action: "revise", label: saving ? "提交中..." : "确认调整", disabled: saving, onClick: handleSubmit },
        ],
      }),
    ],
  });
