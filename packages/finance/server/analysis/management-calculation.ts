...
export function buildPerformanceKpis(input: {
  ...
  return [
    { key: "revenue-growth", label: "营业收入增长率", value: changeRate(input.revenue, input.priorRevenue), priorValue: null, format: "percent", direction: "higher", source: "workpaper" },
    { key: "net-profit", label: "净利润", value: input.netProfit, priorValue: input.priorNetProfit, format: "amount", direction: "higher", source: "workpaper" },
    ...
    { key: "operating-cash", label: "经营现金净额", value: input.operatingCashFlow, priorValue: null, format: "amount", direction: "higher", source: "workpaper" },
