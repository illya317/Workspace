...
const CURRENT_ASSETS: BalanceSheetLineConfig[] = [
  ...
  { lineCode: "cash",              label: "货币资金",               displayCode: "1001+1002+1012", side: "debit", section: "currentAssets", prefixes: ["1001", "1002", "1012"], reclassTarget: true },
  ...
  { lineCode: "otherReceivableNet", label: "其他应收款",            displayCode: "1221-1231", side: "debit", section: "currentAssets", prefixes: ["1221"], subtractPrefixes: ["1231"], reclassSource: true },
  { lineCode: "inventory",         label: "存货",                   displayCode: "1403+1405", side: "debit", section: "currentAssets", prefixes: ["1403", "1405"] },
...
const NON_CURRENT_ASSETS: BalanceSheetLineConfig[] = [
  ...
  { lineCode: "otherEquityInvest",  label: "其他权益工具投资",     displayCode: "1512/1528", side: "debit", section: "nonCurrentAssets", prefixes: ["1512", "1528"] },
  ...
  { lineCode: "fixedAssets",        label: "固定资产",             displayCode: "1601-1602-1603", side: "debit", section: "nonCurrentAssets", prefixes: ["1601"], subtractPrefixes: ["1602", "1603"] },
  ...
  { lineCode: "intangible",         label: "无形资产",             displayCode: "1701-1702", side: "debit", section: "nonCurrentAssets", prefixes: ["1701"], subtractPrefixes: ["1702"] },
  { lineCode: "developmentExpenditure", label: "开发支出",         displayCode: "1704/4301/5301", side: "debit", section: "nonCurrentAssets", prefixes: ["1704", "4301", "5301"] },
  ...
  { lineCode: "rightOfUse",         label: "使用权资产",           displayCode: "1641-1642-1607", side: "debit", section: "nonCurrentAssets", prefixes: ["1641"], subtractPrefixes: ["1642", "1607"] },
...
const CURRENT_LIABILITIES: BalanceSheetLineConfig[] = [
  ...
  { lineCode: "derivativeLiab",     label: "衍生金融负债",         displayCode: "",          side: "credit", section: "currentLiabilities", prefixes: [] },
  ...
  { lineCode: "advanceReceipts",    label: "预收款项",             displayCode: "2203+2205", side: "credit", section: "currentLiabilities", prefixes: ["2203", "2205"] },
  ...
  { lineCode: "interestPayable",    label: "应付利息",             displayCode: "2231",      side: "credit", section: "currentLiabilities", prefixes: ["2231"] },
  { lineCode: "dividendPayable",    label: "应付股利",             displayCode: "2232",      side: "credit", section: "currentLiabilities", prefixes: ["2232"] },
  ...
  { lineCode: "nonCurrentDueWithinYearLiab", label: "一年内到期的非流动负债", displayCode: "", side: "credit", section: "currentLiabilities", prefixes: [] },
  { lineCode: "otherCurrentLiabilities", label: "其他流动负债",    displayCode: "2281",      side: "credit", section: "currentLiabilities", prefixes: ["2281"], reclassSource: true, reclassTarget: true },
...
const EQUITY: BalanceSheetLineConfig[] = [
  ...
  { lineCode: "paidInCapital",      label: "实收资本",             displayCode: "4001/3001", side: "credit", section: "equity", prefixes: ["4001", "3001"] },
  { lineCode: "otherEquityInstruments", label: "其他权益工具",     displayCode: "4401",      side: "credit", section: "equity", prefixes: ["4401"] },
  { lineCode: "capitalReserve",     label: "资本公积",             displayCode: "4002/3002", side: "credit", section: "equity", prefixes: ["4002", "3002"] },
