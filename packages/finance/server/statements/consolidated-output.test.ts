        ...
        reportPayload: {
          ...
          payload: {
            lines: [
              ...
              line("cost", 120, { subtract: true }),
              line("operatingProfit", 80, { isTotal: true }),
              line("incomeTax", 20, { subtract: true }),
              line("netProfit", 60, { isGrandTotal: true }),
            ],
          },
        },
      },
        ...
        reportPayload: {
          ...
          payload: {
            lines: [
              ...
              line("operatingInSubtotal", 100, { direction: "net", isTotal: true }),
              line("purchasePayment", 50, { side: "credit", direction: "out" }),
              line("operatingOutSubtotal", 50, { direction: "net", isTotal: true }),
              line("operatingNet", 50, { direction: "net", isTotal: true }),
              ...
              line("netIncrease", 50, { direction: "net", isGrandTotal: true }),
              line("openingCash", 100, { direction: "in" }),
              line("endingCash", 150, { direction: "net", isGrandTotal: true }),
            ],
          },
        },
      },
...
test("approved eliminations update detail lines and derived totals", () => {
  ...
  assert.equal(balance.lines.find((item) => item.lineCode === "cash")?.amount, 120);
