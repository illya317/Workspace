...
test("parses supplier auxiliary balances with account codes and sides", () => {
  ...
  const preview = parseAuxiliaryBalanceSheet(buffer, "02", 2025, "供应商余额-示例子公司甲2025.xls", ".xls");
...
test("infers person settlement accounts and explicit filename month", () => {
  ...
  const preview = parseAuxiliaryBalanceSheet(buffer, "02", 2026, "应付个人余额-示例子公司甲2026.4.xls", ".xls");
