...
export async function confirmFinanceImport(
  ...
  try {
    ...
    if (preview.type === "account") {
      ...
      return {
        created: count, updated: 0, deleted: 0, skipped: 0,
    ...
    if (preview.type === "balance") {
      ...
      return {
        created: imported, updated: 0, deleted: 0, skipped: 0,
        conflicts: 0, blocked: 0, warnings: [],
        importId: importBatch.id,
        year: preview.year, companyCode: preview.companyCode, type: preview.type,
    ...
    const { created, updated, deleted, skipped, blocked, warnings, affectedPeriodIds } =
    ...
    return {
      created, updated, deleted, skipped, conflicts: 0, blocked, warnings: allWarnings,
      importId: importBatch.id,
      year: preview.year, companyCode: preview.companyCode, type: preview.type,
    };
  } catch (err) {
