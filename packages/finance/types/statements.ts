...
export interface ConsolidationControlDecisionSnapshot {
  ...
  decision: "completed" | "notApplicable";
  conclusion: string;
  evidence: string;
  decidedBy: number;
  decidedAt: string;
...
export interface ConsolidationSourceSelectionInput {
  entitySnapshotId: number;
  reportType: StatementReportType;
  workpaperId?: number | null;
  acceptSystemSource?: boolean;
  evidence?: string | null;
}
...
export interface SaveConsolidationControlDecisionInput {
  expectedRevision: number;
  controlKey: ConsolidationControlDecisionSnapshot["controlKey"];
  decision: ConsolidationControlDecisionSnapshot["decision"];
  conclusion: string;
  evidence: string;
}
