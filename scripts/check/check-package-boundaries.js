...
const PACKAGE_RULES = {
  core: {
    forbidden: [
      { pattern: /^@workspace\/(platform|administration|library|hr|production|finance|capital-securities|external|work)(\/|$)/, reason: "core must not depend on platform or domain packages" },
  ...
  platform: {
    forbidden: [
      ...
      { pattern: /^@\/app\/(administration|library|hr|finance|production|capital-securities|external|work)(\/|$)/, reason: "platform must not import domain UI directly" },
      { pattern: /^@\/server\/services\/(administration|library|hr|finance|production|capital-securities|external|work)(\/|$)/, reason: "platform must not import domain services directly" },
    ],
  },
  administration: {
    forbidden: [
      { pattern: /^@workspace\/(library|hr|finance|production|capital-securities|external|work)(\/|$)/, reason: "administration must not depend on other domain packages" },
      { pattern: /^@\/app\//, reason: "packages must not import Next app route shells" },
  ...
  library: {
    forbidden: [
      { pattern: /^@workspace\/(hr|finance|production|capital-securities|external|work|administration)(\/|$)/, reason: "library must not depend on other domain packages" },
      { pattern: /^@\/app\//, reason: "packages must not import Next app route shells" },
  ...
  hr: {
    forbidden: [
      { pattern: /^@workspace\/(administration|library|finance|production|capital-securities|external|work)(\/|$)/, reason: "hr must not depend on other domain packages" },
      { pattern: /^@\/app\//, reason: "packages must not import Next app route shells" },
  ...
  finance: {
    forbidden: [
      { pattern: /^@workspace\/(administration|library|hr|production|capital-securities|external|work)(\/|$)/, reason: "finance must not depend on other domain packages" },
      { pattern: /^@\/app\//, reason: "packages must not import Next app route shells" },
  ...
  production: {
    forbidden: [
      { pattern: /^@workspace\/(administration|library|hr|finance|capital-securities|external|work)(\/|$)/, reason: "production must not depend on other domain packages" },
      { pattern: /^@\/app\//, reason: "packages must not import Next app route shells" },
  ...
  external: {
    forbidden: [
      { pattern: /^@workspace\/(administration|library|hr|finance|production|capital-securities|work)(\/|$)/, reason: "external must not depend on other domain packages" },
      { pattern: /^@\/app\//, reason: "packages must not import Next app route shells" },
  ...
  "capital-securities": {
    forbidden: [
      { pattern: /^@workspace\/(administration|library|hr|finance|production|external|work)(\/|$)/, reason: "capital-securities must not depend on other domain packages" },
      { pattern: /^@\/app\//, reason: "packages must not import Next app route shells" },
  ...
  work: {
    forbidden: [
      { pattern: /^@workspace\/(administration|library|hr|finance|production|capital-securities|external)(\/|$)/, reason: "work must not depend on other domain packages" },
      { pattern: /^@\/app\//, reason: "packages must not import Next app route shells" },
