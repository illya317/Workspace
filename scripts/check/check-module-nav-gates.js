  ...
  const cases = [
    {
      ...
      text: `export const pkg = { moduleDef: { key: "finance", label: "财务", href: "/finance", iconKey: "finance", color: "amber", children: [{ key: "ledger", label: "总账", href: "/finance/ledger", resourceKey: "finance.ledger" }] } };`,
      expectedOk: false,
    },
    {
      label: "parent has gate, child has gate -> pass",
      text: `export const pkg = { moduleDef: { key: "finance", label: "财务", href: "/finance", iconKey: "finance", color: "amber", resourceKey: "finance", children: [{ key: "ledger", label: "总账", href: "/finance/ledger", resourceKey: "finance.ledger" }] } };`,
      expectedOk: true,
    },
    {
