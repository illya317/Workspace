...
export const SOURCE_CAPABILITY_DECLARATIONS: readonly SourceCapabilityDeclaration[] = [
  ...
  capability("platform", "shell-navigation", "应用壳与导航", {
    files: [
      ...
      "ui/portal-preferences.ts", "ui/useWorkspaceNavigation.ts",
      "server/app-version.ts", "server/release-runtime.test.ts", "server/release-runtime.ts", "server/module-home-page.tsx",
